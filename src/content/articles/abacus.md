...
slug: abacus
description: "An abacus is a manual counting device — one of the oldest calculating tools in human history."
category: everyday-concepts
tags: ["abacus", "counting tool", "mathematics", "arithmetic"]
heroImage: "/images/articles/abacus-hero.webp"
heroAlt: "An abacus is one of the oldest counting tools in history, used for arithmetic across many cultures"
...
externalSources:
  ...
  - title: "Smithsonian — History of the Abacus"
    url: "https://www.si.edu/spotlight/the-abacus"
  - title: "IEEE Global History Network — Abacus"
    url: "https://ethw.org/Abacus"
faq:
  - q: "How old is the abacus?"
  ...
  - q: "Is the abacus still used today?"
    a: "Yes. The abacus remains in use in parts of China, Japan, Russia, and other countries, particularly for teaching arithmetic to children. In Japan, soroban instruction is part of the primary school curriculum. Skilled abacus users can perform calculations as fast as — or faster than — people using electronic calculators, as demonstrated in competitions."
  - q: "Can you do multiplication and division on an abacus?"
    a: "Yes. While addition and subtraction are the most intuitive operations, trained users perform multiplication, division, and even square and cube root calculations on an abacus. The techniques require practice, but they are well-established and have been taught for centuries."
---
