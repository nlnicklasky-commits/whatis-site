...
heroAlt: "A bowl of what appears to be a golden substance, possibly a type of grain or spice, surrounded by small grains or nuts on"
...
externalSources:
  - title: "Science History Institute — Alchemy"
    url: "https://www.sciencehistory.org/topics/alchemy"
  - title: "Britannica — Alchemy"
    url: "https://www.britannica.com/topic/alchemy"
  - title: "MIT Libraries — Alchemy Collection"
    url: "https://libraries.mit.edu/archives/exhibits/alchemy/"
  - title: "Indiana University — The Chymistry of Isaac Newton"
    url: "https://webapp1.dlib.indiana.edu/newton/"
faq:
  - q: "Did any alchemist ever succeed in making gold?"
    a: "No alchemist ever transmuted base metals into gold through chemical means. However, modern nuclear physics can technically create gold by bombarding mercury or platinum with neutrons in a particle accelerator — though the cost far exceeds the value of the gold produced."
  - q: "What is the philosopher's stone?"
    a: "The philosopher's stone was a legendary substance that alchemists believed could transform base metals into gold (transmutation) and produce the Elixir of Life, granting immortality or perfect health. No one ever created it, but the pursuit drove centuries of chemical experimentation."
  - q: "Was Isaac Newton an alchemist?"
    a: "Yes. Newton wrote over a million words on alchemy and practiced it extensively in his private laboratory. He kept this work largely secret because alchemy was considered disreputable even in his era. Scholars now believe his alchemical thinking influenced his scientific work."
  - q: "How did alchemy contribute to modern chemistry?"
...
Paracelsus was also famously disagreeable. He publicly burned the works of Galen and Avicenna, called other physicians "charlatans," and was run out of multiple cities. But his core insight — that [chemistry](/chemistry) could serve medicine — eventually proved correct.
...
The most interesting thing about alchemy isn't that it failed — it's that it failed *productively*. By pursuing impossible goals with genuine rigor, alchemists built the material infrastructure and experimental culture that made modern [chemistry](/chemistry) possible. They didn't turn lead into gold, but they turned mystical speculation into [science](/scientific-method). And frankly, that's a more impressive transmutation.
