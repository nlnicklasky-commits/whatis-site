...
slug: anthropology
description: "Anthropology is the study of humans—past and present—across cultures, biology, language, and societies. Learn its branches, methods, and why it matters."
category: science
...
wordCount: 3265
tier: "1"
relatedArticles: ["aesthetics", "cognitive-bias", "agriculture", "stoicism", "algorithms"]
externalSources:
  - title: "American Anthropological Association — What Is Anthropology?"
    url: "https://www.americananthro.org/what-is-anthropology"
  - title: "Smithsonian National Museum of Natural History — Human Origins"
    url: "https://humanorigins.si.edu/"
  - title: "Stanford Encyclopedia of Philosophy — Philosophy of Anthropology"
    url: "https://plato.stanford.edu/entries/anthropology/"
  - title: "UNESCO — Intangible Cultural Heritage"
    url: "https://ich.unesco.org/en/what-is-intangible-heritage-00003"
faq:
  - q: "What are the four main branches of anthropology?"
    a: "The four main branches are cultural anthropology (studying living cultures), biological/physical anthropology (human evolution and biology), linguistic anthropology (language and communication), and archaeology (studying past societies through material remains)."
  - q: "What degree do you need to become an anthropologist?"
    a: "Most professional anthropologists hold at least a master's degree, and academic positions typically require a PhD. However, a bachelor's degree in anthropology opens doors to careers in market research, cultural resource management, nonprofits, and public health."
  - q: "How is anthropology different from sociology?"
    a: "While both study human societies, anthropology typically examines cultures across all of human history and uses ethnographic fieldwork (often in small-scale communities), whereas sociology tends to focus on modern industrialized societies and relies more on surveys, statistics, and large datasets."
  - q: "What jobs can you get with an anthropology degree?"
    a: "Anthropology graduates work in user experience research, public health, cultural resource management, museum curation, international development, forensic investigation, market research, and government policy analysis, among other fields."
  - q: "Is anthropology a science or a humanity?"
...
If you're curious about how human thinking patterns shape behavior, you might enjoy reading about [cognitive bias](/cognitive-bias), which intersects with anthropological research on decision-making across cultures.
...
The connection between archaeology and [agriculture](/agriculture) is especially deep, since the origins of farming (roughly 10,000-12,000 years ago) represent one of the most dramatic shifts in human history.
...
The ancient Greek and Roman thinkers who influenced [stoicism](/stoicism) were already doing something anthropological when they observed and compared customs across different city-states and civilizations — even if they didn't call it that.
