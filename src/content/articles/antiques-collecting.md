...
description: "Antiques collecting is the practice of seeking out, acquiring, and preserving objects that are at least 100 years old, valued for their craftsmanship."
...
wordCount: 1014
tier: "3"
relatedArticles: ["art-history", "economics", "natural-history", "architecture", "archaeology"]
externalSources:
  - title: "Smithsonian Institution - American Art"
    url: "https://americanart.si.edu/"
  - title: "Antiques Roadshow - PBS"
    url: "https://www.pbs.org/wgbh/roadshow/"
  - title: "U.S. Customs - Importing Antiques"
    url: "https://www.cbp.gov/trade/basic-import-export/importing-antiques"
faq:
  - q: "How old does something have to be to qualify as an antique?"
    a: "The most widely accepted definition requires an item to be at least 100 years old. U.S. Customs uses this threshold for tariff purposes. Items between 20 and 100 years old are generally called 'vintage,' while 'collectible' applies to items valued for reasons beyond age, such as rarity or cultural significance."
  - q: "How do I know if my antique is valuable?"
    a: "Value depends on several factors: rarity, condition, provenance (ownership history), maker or manufacturer, and current market demand. A professional appraisal from a certified appraiser affiliated with the American Society of Appraisers or the Appraisers Association of America is the most reliable way to determine value."
  - q: "Where is the best place to buy antiques?"
    a: "Common sources include estate sales, auction houses (both local and major firms like Christie's or Sotheby's), antique shops and malls, flea markets, and online platforms like eBay, Ruby Lane, and 1stDibs. Estate sales often offer the best prices because items are typically priced to sell quickly."
---
...
From Chinese blue-and-white porcelain (some dating to the 14th century) to English Wedgwood to American stoneware, [ceramics](/ceramics) represent one of the deepest collecting fields. Marks on the bottom of pieces help identify makers and periods, and entire reference libraries exist just for ceramic marks.
...
First editions, manuscripts, maps, and historical documents form their own collecting world. A first edition of *The Great Gatsby* in good condition has sold for over $400,000. Even more modest items — 19th-century [maps](/cartography), handwritten letters from minor historical figures — have active markets.
