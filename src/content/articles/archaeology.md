...
slug: archaeology
description: "Archaeology is the study of human history through physical remains like artifacts, buildings, and bones. Learn about methods, famous discoveries, and careers."
category: science
...
wordCount: 2751
tier: "2"
relatedArticles: ["anthropology", "anatomy", "aesthetics", "agriculture", "agronomy"]
externalSources:
  - title: "Society for American Archaeology"
    url: "https://www.saa.org/"
  ...
  - title: "Bureau of Labor Statistics: Anthropologists and Archaeologists"
...
faq:
  - q: "What is the difference between archaeology and paleontology?"
    a: "Archaeology studies human history and prehistory through material remains — artifacts, buildings, tools, and human bones. Paleontology studies ancient life more broadly, including dinosaurs, ancient plants, and pre-human organisms, primarily through fossils. The key distinction: archaeology focuses on humans and their ancestors; paleontology covers all ancient life forms."
  - q: "How old do things have to be to be considered archaeological?"
    a: "There's no strict age cutoff. Archaeology covers everything from 3.3-million-year-old stone tools to World War II shipwrecks. Some archaeologists study garbage dumps from the 1970s. The defining factor isn't age — it's method. If you're studying human behavior through physical remains rather than written records alone, you're doing archaeology."
  - q: "Do archaeologists really use small brushes?"
    a: "Sometimes, yes — when working near fragile artifacts or human remains. But most excavation involves shovels, trowels, picks, and even heavy machinery for removing overburden. The careful brushwork you see in movies represents only the final, most delicate stage of a dig. The reality involves a lot more dirt and sweat than Hollywood suggests."
  - q: "Can you make a living as an archaeologist?"
    a: "Yes, though the pay varies widely. The median salary for anthropologists and archaeologists was about $61,910 in 2023 according to the BLS. Cultural resource management (CRM) firms, which conduct archaeological surveys before construction projects, employ the most archaeologists. Academic positions are competitive but available. Government agencies, museums, and nonprofits also hire archaeologists."
  - q: "What is the most important archaeological discovery ever made?"
...
This is where most of the work happens. Artifacts are cleaned, cataloged, measured, and analyzed. Pottery specialists (ceramicists) classify sherds by type and date them. Lithic analysts study stone tools. Zooarchaeologists identify [animal](/animal-behavior) bones to reconstruct diet. Archaeobotanists analyze plant remains. Physical [anthropologists](/anthropology) study human skeletal remains for age, sex, health, and cause of death.
...
**Machine learning** is being applied to pottery classification, site detection from satellite imagery, and even the decipherment of ancient scripts. [Artificial intelligence](/artificial-intelligence) won't replace archaeologists, but it's accelerating analysis of the massive datasets modern excavations produce.
