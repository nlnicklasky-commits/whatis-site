...
slug: argumentation
description: "Argumentation is the process of constructing and evaluating reasoned claims. Learn about logical structure, fallacies, debate, and how to argue effectively."
category: philosophy
...
heroAlt: "A man and a woman in business attire engaged in a discussion at a conference table"
...
wordCount: 2769
tier: "2"
relatedArticles: ["aesthetics", "stoicism", "cognitive-bias", "algorithms", "anthropology"]
externalSources:
  - title: "Stanford Encyclopedia of Philosophy: Argumentation"
    url: "https://plato.stanford.edu/entries/argumentation/"
  - title: "Internet Encyclopedia of Philosophy: Informal Logic"
    url: "https://iep.utm.edu/inf-log/"
...
*Premise 1:* All mammals produce milk.
*Premise 2:* Whales are mammals.
*Conclusion:* Therefore, whales produce milk.
...
2. **Grounds (data)** — the evidence supporting the claim
3. **Warrant** — the reasoning that connects the grounds to the claim (often unstated)
...
Social media compresses arguments into 280 characters or a few seconds of video. Nuance gets lost. [Cognitive biases](/cognitive-bias) — confirmation bias, availability bias, bandwagon effects — are amplified by algorithmic curation that shows you content you're likely to agree with.
