...
wordCount: 989
tier: "3"
relatedArticles: ["acoustics", "blues-music", "physics", "audio-engineering", "sound-engineering"]
externalSources:
  - title: "Fender - History of the Bass Guitar"
    url: "https://www.fender.com/articles/gear/a-brief-history-of-bass"
  - title: "Bass Player Magazine"
    url: "https://www.bassplayer.com/"
  - title: "Encyclopedia Britannica - Bass Guitar"
    url: "https://www.britannica.com/art/bass-guitar"
faq:
  - q: "How many strings does a bass guitar have?"
    a: "The standard bass guitar has four strings, tuned E-A-D-G (the same as the lowest four strings of a regular guitar, but one octave lower). Five-string basses add a low B string, and six-string basses add both a low B and high C. Four-string remains the most common configuration for most genres."
  - q: "Is bass guitar easier than regular guitar?"
    a: "Getting started on bass is often easier — simpler chord structures, one note at a time rather than chords, and wider string spacing. But mastering bass is equally challenging. Good bass playing requires precise timing, knowledge of harmony, and the ability to lock in with the drummer — skills that take years to develop."
  - q: "What is the difference between bass guitar and double bass?"
    a: "The electric bass guitar is a solid-body instrument played horizontally, fretted, and amplified electronically. The double bass (upright bass) is a large acoustic instrument played vertically, typically fretless, used in orchestras, jazz, and some folk music. Leo Fender designed the electric bass partly to replace the double bass with something more portable and easier to amplify."
---
...
The [physics](/physics) behind this is straightforward. Bass frequencies (roughly 40-400 Hz) have long wavelengths that propagate through space and solid objects differently than higher frequencies. You feel bass in your body because low-frequency sound waves physically vibrate your chest cavity and internal organs. That's not a metaphor — it's [acoustics](/acoustics).
...
**Bootsy Collins** — Funk incarnate. His work with James Brown and Parliament-Funkadelic defined the slap-heavy, groove-driven [funk](/blues-music) bass style.
