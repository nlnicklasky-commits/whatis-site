...
heroAlt: "A person's hands working on a wooden board filled with colorful beads, suggesting they are engaged in beadwork or crafting"
...
**Stringing** — threading beads onto cord, wire, or thread — is the simplest technique and the basis for most bead [jewelry](/art-history) making. Knotting between beads (standard for pearls) prevents all beads from scattering if the strand breaks.
