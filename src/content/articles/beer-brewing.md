...
slug: beer-brewing
description: "Beer brewing is the process of converting grain starches — usually from malted barley — into a fermented alcoholic beverage through mashing, boiling."
category: everyday-concepts
tags: ["beer brewing", "brewing", "beer", "hops", "malt", "yeast"]
heroImage: "/images/articles/beer-brewing-hero.webp"
heroAlt: "An elderly man with dreadlocks and a long beard, standing in a field with a cloudy sky in the background"
...
wordCount: 1004
tier: "3"
relatedArticles: ["fermentation", "food-science", "food-chemistry", "chemistry", "agriculture"]
externalSources:
  - title: "Brewers Association"
    url: "https://www.brewersassociation.org/"
  - title: "American Homebrewers Association"
    url: "https://www.homebrewersassociation.org/"
  - title: "Encyclopedia Britannica - Brewing"
    url: "https://www.britannica.com/topic/brewing"
faq:
  - q: "What are the four main ingredients in beer?"
    a: "Beer is made from four basic ingredients: water (which comprises 90-95% of beer), malted barley (or other grains, providing sugars for fermentation and flavor), hops (flowers that add bitterness, flavor, and aroma while acting as a natural preservative), and yeast (microorganisms that convert sugars to alcohol and carbon dioxide through fermentation)."
  - q: "How long does it take to brew beer?"
    a: "The brewing process (mashing, boiling, cooling) takes about 4-8 hours in a single day. Fermentation then takes 1-2 weeks for ales and 4-8 weeks for lagers. After fermentation, beer may need an additional 1-4 weeks for conditioning and carbonation. From brew day to drinkable beer, expect 3-8 weeks total depending on the style."
  - q: "What is the difference between ale and lager?"
    a: "The fundamental difference is yeast. Ales use top-fermenting yeast (Saccharomyces cerevisiae) that works at warmer temperatures (60-75°F) and ferments faster. Lagers use bottom-fermenting yeast (Saccharomyces pastorianus) that works at cooler temperatures (45-55°F) and requires longer conditioning. This produces different flavor profiles — ales tend to be fruitier; lagers tend to be cleaner and crisper."
---

# What Is Beer Brewing?

Beer brewing is the process of converting grain starches — usually from malted barley — into a fermented alcoholic beverage through mashing, boiling, and yeast [fermentation](/fermentation). Humans have been brewing beer for at least 7,000 years, making it one of the oldest prepared beverages in civilization.
...
During fermentation, yeast metabolizes sugars into ethanol and carbon dioxide while producing hundreds of flavor-active compounds. The [food science](/food-science) of fermentation is remarkably complex — yeast cells undergo stress responses, nutrient uptake cycles, and flavor compound production that PhD dissertations are written about.
...
The number of U.S. craft breweries exceeded 9,500 in 2023 — more than at any point in American [history](/natural-history). The craft segment accounts for roughly 25% of the U.S. beer market by revenue. The explosion of small, independent breweries has created local beer cultures in virtually every American city.
