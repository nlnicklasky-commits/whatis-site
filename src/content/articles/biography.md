...
slug: biography
description: "A biography is a nonfiction account of a person's life written by someone other than the subject."
...
wordCount: 922
tier: "3"
relatedArticles: ["art-history", "natural-history", "philosophy-of-education", "psychology", "oral-history"]
externalSources:
  - title: "Biography.com"
    url: "https://www.biography.com/"
  - title: "Pulitzer Prize - Biography"
    url: "https://www.pulitzer.org/prize-winners-by-category/220"
  - title: "Encyclopedia Britannica - Biography"
    url: "https://www.britannica.com/art/biography-narrative-genre"
faq:
  - q: "What is the difference between a biography and an autobiography?"
    a: "A biography is written by someone other than the subject, based on research, interviews, and primary sources. An autobiography is written by the subject themselves, drawing on personal memory and experience. A third form, memoir, differs from autobiography by focusing on specific themes or periods rather than covering the subject's entire life chronologically."
  - q: "What makes a good biography?"
    a: "Good biographies combine thorough research with compelling narrative. They place the subject in historical context, present a balanced portrayal (acknowledging flaws alongside achievements), use primary sources like letters and diaries, and make the reader care about the subject as a human being rather than just a list of accomplishments. The best biographies read like novels while maintaining scholarly accuracy."
  - q: "What is the longest biography ever written?"
    a: "The longest biography in English is generally considered to be Dumas Malone's six-volume 'Jefferson and His Time' (1948-1981), spanning approximately 3,600 pages. Winston Churchill's official biography, begun by Randolph Churchill and completed by Martin Gilbert, runs to eight volumes plus companion document volumes totaling over 10,000 pages."
---
...
**Historical understanding** — Individual lives illuminate broader [historical](/anthropology) patterns. A biography of Frederick Douglass reveals not just one man's story but the entire system of American slavery and abolition. A biography of Marie Curie illuminates early 20th-century science, gender barriers, and the discovery of radioactivity.
