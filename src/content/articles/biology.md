...
slug: biology
description: "Biology is the scientific study of living organisms and life processes. Learn about cells, genetics, evolution, ecosystems, and the major branches of biology."
category: science
...
heroAlt: "A group of scientists in a laboratory setting, focused on a microscope and examining a sample"
...
Since the Human Genome Project, the cost of sequencing a genome has dropped from about $3 billion to under $200. This has enabled population-scale genomics, personalized medicine, and a flood of genetic data that requires sophisticated [computational tools](/algorithms) to analyze.
...
3. More organisms are born than can survive.
4. Individuals with traits better suited to their environment are more likely to survive and reproduce.
5. Over generations, beneficial traits become more common in the population.
