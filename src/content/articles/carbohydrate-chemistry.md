...
description: "Carbohydrate chemistry studies the structure, synthesis, and reactions of sugars and polysaccharides, from glucose molecules to cellulose and starch."
category: science
...
externalSources:
  ...
  - title: "Essentials of Glycobiology - NCBI Bookshelf"
    url: "https://www.ncbi.nlm.nih.gov/books/NBK310274/"
  - title: "Carbohydrate Chemistry - Royal Society of Chemistry"
    url: "https://www.rsc.org/publishing/journals/carbohydrate-chemistry/"
  - title: "USDA FoodData Central - Carbohydrates"
    url: "https://fdc.nal.usda.gov/"
faq:
  - q: "Are carbohydrates just sugars?"
    a: "No. Sugars are the simplest carbohydrates (monosaccharides and disaccharides), but carbohydrates also include starches, cellulose, chitin, and other complex polysaccharides. Many carbohydrates don't taste sweet at all — wood is mostly cellulose, which is a carbohydrate."
  - q: "Why are carbohydrates called carbohydrates?"
    a: "The name comes from their general molecular formula: Cn(H2O)n — carbon plus water, or 'hydrated carbon.' Early chemists noticed that these molecules contained carbon, hydrogen, and oxygen in a ratio that looked like carbon combined with water. The name stuck, even though some carbohydrates don't fit this formula exactly."
  - q: "What is the difference between simple and complex carbohydrates?"
    a: "Simple carbohydrates are monosaccharides (single sugar units like glucose) and disaccharides (two units like sucrose). Complex carbohydrates are polysaccharides — long chains of sugar units like starch, glycogen, and cellulose. Complex carbohydrates take longer to digest and generally cause slower, steadier changes in blood sugar."
  - q: "Why can humans digest starch but not cellulose?"
    a: "Both are made of glucose, but the linkages differ. Starch uses alpha-1,4 linkages that human enzymes (amylases) can break. Cellulose uses beta-1,4 linkages that our enzymes cannot break. Cows and termites can digest cellulose because they host microorganisms that produce the necessary enzymes."
---
...
In bread baking, the CO₂ is the point — it creates the air pockets that give bread its structure. In brewing, the ethanol is the point. In both cases, you're witnessing carbohydrate chemistry at work. [Sourdough](/sourdough) baking adds complexity because wild yeast and lactic acid bacteria compete for and transform the available sugars differently than commercial yeast.
...
Understanding [anatomy](/anatomy) at the cellular level means understanding how cells process carbohydrates — it's that fundamental to biology.
...
Cotton processing — ginning, carding, spinning — is essentially manipulation of pure cellulose fibers. The cotton [agriculture](/agriculture) industry produces about 25 million metric tons annually, making it one of the world's most important carbohydrate-based commodities.
