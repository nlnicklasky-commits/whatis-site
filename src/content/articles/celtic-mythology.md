...
heroAlt: "A large stone monument with intricate carvings stands in a lush, forested area, surrounded by sunlight filtering through"
...
wordCount: 1086
tier: "3"
relatedArticles: ["chinese-mythology", "anthropology", "art-history", "biography", "architecture"]
externalSources:
  - title: "CELT - Corpus of Electronic Texts (University College Cork)"
    url: "https://celt.ucc.ie/"
  - title: "National Museum of Ireland"
    url: "https://www.museum.ie/"
  - title: "Encyclopedia Britannica - Celtic Religion"
    url: "https://www.britannica.com/topic/Celtic-religion"
faq:
...
The Dagda, chief of the Tuatha Dé Danann, carries a club that kills with one end and resurrects with the other, and owns a cauldron that never empties. Lugh, the "many-skilled" god, excels at every art and craft simultaneously. Brigid presides over [poetry](/poetry), healing, and smithwork — three skills the Celts apparently considered related. The Morrígan is a shape-shifting war goddess who appears as a crow over battlefields and whose favor determines victory or defeat.
...
Samhain (November 1) — the ancestor of [Halloween](/anthropology) — was the time when the boundary between worlds was thinnest. The dead could visit the living. The living could stumble into the Otherworld. Time there moves differently: spend a day among the *sídhe* and return to find decades have passed.

This concept — that the supernatural isn't above or below but *beside* — gives Celtic mythology a distinctive quality. The gods didn't live on a distant mountain. They lived in the hill outside town. Magic wasn't rare or dramatic. It was woven into the field, present in certain [springs](/springs), stones, trees, and twilight moments.

## Why Celtic Mythology Endures

Celtic myths have influenced Western [literature](/literature) out of all proportion to their fragmentary survival. Yeats built a literary career on them. Tolkien drew heavily on Celtic sources. Modern [fantasy literature](/fantasy-literature), from *The Chronicles of Prydain* to *The Name of the Wind*, echoes Celtic themes and structures.
