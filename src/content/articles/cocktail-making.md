...
heroAlt: "A bartender pouring a layered cocktail through a strainer into a coupe glass"
...
externalSources:
  ...
  - title: "USDA - Alcohol and Public Health"
    url: "https://www.cdc.gov/alcohol/index.html"
  - title: "Oxford Companion to Spirits and Cocktails"
    url: "https://global.oup.com/academic/product/the-oxford-companion-to-spirits-and-cocktails-9780199311132"
faq:
  - q: "What are the five basic cocktail techniques?"
  ...
  - q: "What tools do you need to start making cocktails at home?"
    a: "The essentials are a shaker (Boston or cobbler style), a jigger for measuring, a bar spoon, a strainer (Hawthorne type), and a muddler. A good set costs between 25 and 50 dollars. Beyond that, having fresh citrus, simple syrup, and a few core spirits (vodka, gin, whiskey, rum) covers most classic recipes."
  - q: "What is the oldest known cocktail?"
...
The craft cocktail revival that started in the early 2000s brought everything back. Bartenders began studying pre-Prohibition recipes, sourcing obscure ingredients, and treating drink-making with the same seriousness chefs bring to [cooking](/cooking). Today, a well-made cocktail can be as complex and thoughtful as a restaurant dish.
...
The modern cocktail renaissance, often traced to bars like Milk & Honey (opened in New York in 2000), brought a level of obsessiveness to drink-making that mirrors what happened with [craft beer](/craft-beer) and artisan food.
