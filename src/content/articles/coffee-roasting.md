...
heroAlt: "A large metal coffee roasting machine with a pile of roasted coffee beans in the foreground"
...
externalSources:
  ...
  - title: "USDA - Coffee Production Data"
    url: "https://www.usda.gov/"
  - title: "National Coffee Association USA"
    url: "https://www.ncausa.org/"
faq:
  - q: "What is first crack in coffee roasting?"
    a: "First crack is an audible popping sound that occurs when beans reach about 196 degrees Celsius (385 degrees Fahrenheit). Moisture inside the bean turns to steam, building pressure until the cell structure fractures. First crack signals that the beans have reached a light roast level and are technically drinkable, though roasters often continue for darker profiles."
  - q: "Does darker roast mean more caffeine?"
    a: "No — it is actually the opposite. Dark roast beans have slightly less caffeine by weight than light roasts because the longer roasting process breaks down some caffeine molecules. However, the difference is small (roughly 5-10%), and brewing method affects caffeine extraction far more than roast level."
  - q: "Can you roast coffee at home?"
