...
heroAlt: "Color theory explains how colors interact, combine, and affect perception"
...
externalSources:
  ...
  - title: "Munsell Color Science - RIT"
    url: "https://www.rit.edu/science/munsell-color-science-laboratory"
  - title: "NASA - The Electromagnetic Spectrum"
    url: "https://science.nasa.gov/ems/"
faq:
  - q: "What are the three primary colors?"
    a: "It depends on the system. In traditional art (subtractive mixing), the primaries are red, yellow, and blue. In printing (CMYK), they are cyan, magenta, and yellow. In light (additive mixing, RGB), they are red, green, and blue. Each system reflects a different physical process of how colors combine."
  - q: "What is the difference between hue, saturation, and value?"
    a: "Hue is the color itself — red, blue, green. Saturation (or chroma) is the color's intensity or purity — a vivid red vs. a muted, grayish red. Value (or lightness) is how light or dark a color is. Together, these three properties describe any color precisely and are the basis of the HSV color model used in digital design."
  - q: "Why do some color combinations look good together?"
...
**Split-complementary** uses one color plus the two colors adjacent to its complement. It provides contrast without the intensity of a straight complementary scheme. [Graphic designers](/graphic-design) love this one because it's versatile and hard to mess up.
