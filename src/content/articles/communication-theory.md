...
description: "Communication theory studies how messages are created, transmitted, received, and interpreted between individuals, groups, and mass audiences."
category: science
...
In the social media era, agenda-setting has become more complex. Traditional media still sets agendas, but so do viral posts, influencers, and [algorithm](/algorithms)-driven feeds. The question isn't whether agenda-setting still works — it's who's doing the setting.
...
**Algorithmic curation** means that your information environment is personalized in ways previous generations never experienced. Your [news feed is filtered](/collaborative-filtering) by algorithms that optimize for engagement, not accuracy or comprehensiveness. Two neighbors can live in entirely different information universes despite sharing the same physical community.
