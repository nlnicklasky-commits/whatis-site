...
description: "Computational physics is the branch of physics that uses numerical algorithms, computer simulations."
category: science
...
Finite element methods (FEM) divide space into irregular elements (triangles, tetrahedra) that can conform to complex geometries. FEM is the standard approach for [structural engineering](/structural-engineering) ([aerodynamics](/aerodynamics), bridge design, crash simulation) and is widely used in electromagnetic, thermal, and acoustic analyses.
