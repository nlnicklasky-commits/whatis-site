...
heroAlt: "Abstract representation of algorithms and data structures with binary code and logic gates"
...
Personal computers put computing in everyone's hands. The graphical user interface (Xerox PARC, then Apple, then Microsoft) made computers accessible to non-experts. Object-oriented programming (Smalltalk, C++, Java) became the dominant programming model.
...
[Machine learning](/machine-learning) and artificial intelligence, after multiple "AI winters," finally delivered on decades of promises. Deep learning (neural networks with many layers) enabled breakthroughs in image recognition, natural language processing, game playing, and code generation.
