...
wordCount: 1032
tier: "3"
relatedArticles: ["architecture", "civil-engineering", "carpentry", "masonry", "barbecuing"]
externalSources:
  - title: "Bureau of Labor Statistics - Construction"
...
faq:
  - q: "How big is the construction industry?"
    a: "Global construction output exceeds 13 trillion dollars annually, making it one of the world's largest industries. In the United States alone, the industry employs about 8 million workers and contributes roughly 4.1% of GDP. Construction accounts for approximately 13% of global GDP when all related activities are included."
  - q: "What are the main types of construction?"
    a: "The industry divides into residential construction (homes, apartments), commercial construction (offices, retail, hotels), industrial construction (factories, power plants, refineries), infrastructure construction (roads, bridges, utilities), and institutional construction (schools, hospitals, government buildings). Each type involves different regulations, methods, and specializations."
  - q: "Why do construction projects go over budget so often?"
...
**Concrete workers** pour and finish foundations, slabs, and structural elements. **Steelworkers** (ironworkers) erect structural steel frames. **[Carpenters](/carpentry)** handle wood framing, formwork, and finish carpentry. **Electricians** install wiring, panels, and fixtures. **Plumbers** install piping for water, gas, and drainage. **HVAC technicians** handle heating, ventilation, and [air conditioning](/air-conditioning) systems.

Then there are [masons](/masonry), glaziers (glass), roofers, drywall installers, painters, flooring specialists, elevator installers, fire protection installers, and more. A large commercial project might involve 30+ different trades, each with their own schedule, workspace needs, and inspection requirements.
