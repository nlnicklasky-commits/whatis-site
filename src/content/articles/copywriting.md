...
heroAlt: "A woman in a dark blazer is sitting at a desk, focused on writing on a laptop computer"
...
externalSources:
  ...
  - title: "Bureau of Labor Statistics - Writers"
...
**Direct response** copy asks for an immediate, measurable action — click this link, call this number, buy this product now. Every word exists to move the reader toward conversion. Direct response copywriters are measured by results, which makes this the most accountability-driven form of [writing](/creative-writing).
...
2. **Outline and draft** (20-30%): Structure the piece, write headlines and subheads, draft body copy. Most copywriters write multiple headline options — often 25 to 50 variations before selecting the strongest.

3. **Edit and refine** (20-30%): Cut ruthlessly. Tighten sentences. Strengthen verbs. Remove every word that doesn't earn its place. Good copy is almost always shorter than the first draft.

4. **Test** (ongoing): In digital [marketing](/digital-marketing), copy is tested constantly. A/B tests compare headlines, calls to action, email subject lines, and page structures. Data determines what works, and the copy evolves accordingly.
