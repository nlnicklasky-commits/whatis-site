---
title: "What Is Desalination?"
slug: desalination
description: "Desalination removes salt from seawater to produce fresh drinking water. Learn about reverse osmosis, thermal methods, costs, and environmental concerns."
category: science
...
wordCount: 2420
tier: "2"
relatedArticles: ["alternative-energy", "acoustics", "agriculture", "air-conditioning", "aerospace-engineering"]
externalSources:
  - title: "Wikipedia - Desalination"
    url: "https://en.wikipedia.org/wiki/Desalination"
  - title: "USGS - Desalination"
...
1. **Intake**: Seawater is drawn from the ocean through screened intakes that exclude marine life
2. **Pretreatment**: Filtration removes suspended solids. Chemical treatment prevents biological growth and scaling on membranes. This step is critical—membrane fouling is the primary operational challenge in RO plants.
3. **High-pressure pumping**: Pumps pressurize the pretreated water to 55-80 bar
4. **Membrane separation**: Water passes through membranes; salt is rejected. Typical recovery is 40-50% of incoming water becomes fresh; the rest is concentrated brine.
5. **Energy recovery**: Modern plants use energy recovery devices that capture pressure from the brine stream, reducing energy consumption by up to 60%. This single innovation has been the biggest factor in making RO economically viable.
6. **Post-treatment**: Minerals are added back (desalinated water is too pure for pleasant taste and can be corrosive to pipes). pH is adjusted. Chlorine is added for distribution system protection.
