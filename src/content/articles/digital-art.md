...
heroAlt: "The woman is sitting at a desk, focused on writing or drawing on a notebook, with two computer monitors displaying various"
...
**Digital painting and [illustration](/illustration)** is the most straightforward — an artist uses a stylus and tablet to paint or draw, producing work that might look indistinguishable from traditional media or might embrace clearly digital [aesthetics](/aesthetics). Concept art for films, games, and animation is predominantly digital now.
...
**3D art** encompasses modeling, sculpting, texturing, lighting, and rendering three-dimensional objects and environments. The line between 3D art and [animation](/animation) blurs constantly — a still render and a moving scene use the same fundamental tools.
