...
heroAlt: "A man kneeling down and petting a golden retriever dog in a park"
...
Group classes ($100-$200 for a 6-week session) work well for basic [obedience](/education) and socialization. Private sessions ($75-$200 per hour) address specific behavioral concerns more efficiently. Board-and-train programs ($1,000-$5,000) can jump-start training but only work if the owner learns and maintains the skills afterward.
