...
description: "Eastern philosophy refers broadly to the philosophical traditions that developed in Asia — primarily in India, China, and Japan — over the past 3,000+ years."
...
externalSources:
  ...
  - title: "Internet Encyclopedia of Philosophy - Eastern Philosophy"
    url: "https://iep.utm.edu/"
  - title: "BBC - Eastern Philosophy Guide"
    url: "https://www.bbc.co.uk/religion/"
faq:
  - q: "What is the main difference between Eastern and Western philosophy?"
    a: "The broadest generalization (with many exceptions) is that Western philosophy tends to emphasize rational analysis, logical argumentation, and individual identity, while Eastern philosophy tends to emphasize experiential understanding, harmony with nature, and the dissolution or transcendence of the individual self. Western philosophy asks 'What is true?' through logic. Eastern philosophy often asks 'How should one live?' through practice. Both traditions are far more diverse than any simple comparison suggests."
  - q: "Is Eastern philosophy a religion or a philosophy?"
    a: "The boundary between philosophy and religion is less rigid in Eastern traditions than in Western ones. Buddhism, Hinduism, Taoism, and Confucianism contain both philosophical arguments and religious practices. Confucianism is primarily ethical philosophy with ritual elements. Buddhism can be practiced as philosophy (without supernatural beliefs) or as religion (with cosmology, deities, and afterlife beliefs). The Western distinction between philosophy and religion doesn't map cleanly onto Eastern traditions."
  - q: "Can you practice Eastern philosophy without being religious?"
...
Indian philosophy is among the oldest in the world. The Vedas, composed roughly 1500-500 BC, contain philosophical speculation about the nature of reality, consciousness, and the self that predates Socrates by centuries.

**Hinduism** isn't a single philosophy — it's a vast family of philosophical schools. The key concepts most people encounter:

*Brahman* is the ultimate reality — an infinite, eternal, unchanging ground of all existence. *Atman* is the individual self or soul. The central insight of the Upanishads (philosophical texts from roughly 800-200 BC) is that Atman and Brahman are ultimately identical — your deepest self *is* the ultimate reality. The phrase *tat tvam asi* ("thou art that") captures this idea.

*Karma* means action — and specifically, that actions have consequences that extend across lifetimes. Good actions lead to favorable circumstances; harmful actions lead to suffering. This isn't cosmic punishment; it's presented as a natural law, like gravity.

*Moksha* is liberation — freedom from the cycle of birth, death, and rebirth (samsara). Different Hindu schools propose different paths to liberation: knowledge (jnana yoga), devotion (bhakti yoga), action (karma yoga), or [meditation](/meditation) (raja yoga).

**Buddhism** began when Siddhartha Gautama (the Buddha, c. 5th century BC) taught that suffering is the central problem of existence and that it arises from craving, attachment, and ignorance about the nature of the self.
...
The *Tao* (the Way) is the fundamental principle underlying all of reality — but it can't be defined, described, or grasped intellectually. The Tao Te Ching opens: "The Tao that can be spoken is not the eternal Tao." This isn't mystical obscurantism; it's a claim about the limits of language and conceptual thought.

*Wu wei* (non-action, or effortless action) is Taoism's most distinctive concept. It doesn't mean passivity — it means acting in alignment with the natural flow of things rather than forcing outcomes through willful effort. Water, which is soft and yielding yet carves canyons, is the classic Taoist metaphor. The skilled craftsman who works without thinking, the athlete "in the zone" — these exemplify wu wei.

The *yin-yang* symbol, now so ubiquitous it appears on dorm room posters and tattoos, represents the Taoist insight that apparent opposites are complementary and interdependent. Light contains darkness. Strength contains weakness. Joy contains sadness. The universe functions through the interplay of opposites, not the triumph of one over the other.

## Japanese Contributions

Japanese philosophy drew from both Chinese (Confucianism, Taoism) and Indian (Buddhism) traditions while developing distinctive expressions.
...
That emphasis on practice, on embodied understanding, on the gap between knowing something intellectually and knowing it experientially — this might be what the Western philosophical tradition needs most.
