...
wordCount: 2483
tier: "2"
relatedArticles: ["capitalism", "budgeting", "corporate-finance", "business-administration", "credit-management"]
externalSources:
  - title: "Bureau of Economic Analysis (BEA)"
    url: "https://www.bea.gov/"
  - title: "Federal Reserve Education Resources"
...
faq:
  - q: "Is economics a science?"
    a: "Economics is classified as a social science. It uses scientific methods—hypothesis formation, data collection, statistical testing—but differs from natural sciences because it studies human behavior, which is harder to predict than physical phenomena. Controlled experiments are difficult (though not impossible) in economics, so researchers often rely on observational data and natural experiments."
  - q: "What's the difference between microeconomics and macroeconomics?"
    a: "Microeconomics studies individual decision-makers—consumers, firms, and specific markets. Macroeconomics studies the economy as a whole—GDP, inflation, unemployment, and national policy. They're interconnected: macroeconomic outcomes emerge from the accumulated decisions of millions of microeconomic actors."
  - q: "Why should I learn economics if I'm not an economist?"
