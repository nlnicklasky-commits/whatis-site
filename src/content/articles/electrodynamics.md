---
title: "What Is Electrodynamics?"
slug: electrodynamics
description: "Electrodynamics studies how electric and magnetic fields interact with charged particles. Learn about Maxwell's equations, electromagnetic waves, and more."
category: science
...
heroAlt: "A man in a white lab coat working on a device with an illuminated ball in front of him"
...
wordCount: 2813
tier: "2"
relatedArticles: ["classical-mechanics", "astrophysics", "cosmology", "chemistry", "digital-signal-processing"]
externalSources:
  - title: "Maxwell's Equations - HyperPhysics"
    url: "http://hyperphysics.phy-astr.gsu.edu/hbase/electric/maxeq.html"
  - title: "Classical Electrodynamics - MIT OpenCourseWare"
    url: "https://ocw.mit.edu/courses/8-07-electromagnetism-ii-fall-2012/"
  - title: "Electrodynamics - Britannica"
    url: "https://www.britannica.com/science/electrodynamics"
  - title: "NIST Electromagnetic Theory"
    url: "https://www.nist.gov/pml/electromagnetics"
faq:
  - q: "What is the difference between electrostatics and electrodynamics?"
    a: "Electrostatics deals with stationary electric charges and the constant electric fields they produce. Electrodynamics deals with charges in motion, time-varying fields, and the interplay between electric and magnetic phenomena. Electrostatics is essentially a special, simplified case of the broader theory of electrodynamics."
  - q: "Are Maxwell's equations difficult to understand?"
    a: "The conceptual ideas behind Maxwell's equations are accessible to anyone: charges create electric fields, currents create magnetic fields, changing fields create each other. The mathematical formulation requires vector calculus, which is typically covered in university-level math courses. The concepts are intuitive; the full math takes some effort."
  - q: "How does electrodynamics relate to light?"
    a: "Light is an electromagnetic wave, and Maxwell's equations predict its existence, speed, and behavior. When Maxwell calculated the speed of electromagnetic waves from his equations, it matched the measured speed of light exactly — leading him to conclude that light itself was electromagnetic in nature. This was one of the most stunning unifications in the history of physics."
  - q: "What is quantum electrodynamics?"
    a: "Quantum electrodynamics (QED) is the quantum mechanical version of classical electrodynamics. It describes how light and matter interact at the subatomic level, treating electromagnetic fields as quantized photons rather than continuous waves. QED is considered the most precisely tested theory in all of physics, with predictions matching experiments to more than 10 decimal places."
---
