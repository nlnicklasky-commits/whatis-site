...
slug: ethnobotany
description: "Ethnobotany studies how people use plants for food, medicine, shelter, and ritual. Learn about traditional knowledge, medicinal plants, and conservation."
category: science
...
heroAlt: "The man is holding a plant with yellow flowers in a lush, green forest"
...
wordCount: 2539
tier: "2"
relatedArticles: ["botany", "anthropology", "agriculture", "biochemistry", "conservation-biology"]
externalSources:
  - title: "Society for Economic Botany"
    url: "https://www.econbot.org/"
  - title: "New York Botanical Garden - Ethnobotany"
    url: "https://www.nybg.org/plant-research-and-conservation/ethnobotany/"
  - title: "Kew Royal Botanic Gardens - Ethnobotany"
...
faq:
  - q: "What is the difference between ethnobotany and botany?"
    a: "Botany is the scientific study of plants — their biology, genetics, physiology, and taxonomy. Ethnobotany specifically studies the relationship between people and plants, focusing on how different cultures use, name, manage, and perceive plants. Ethnobotany combines botanical science with anthropology, linguistics, and cultural studies."
  - q: "How has ethnobotany contributed to modern medicine?"
    a: "Roughly 25% of modern pharmaceuticals are derived from or inspired by plant compounds first identified through traditional use. Aspirin came from willow bark, morphine from opium poppies, quinine (antimalarial) from cinchona bark, and the cancer drug taxol from Pacific yew bark. Ethnobotanical research continues to identify promising plant compounds for drug development."
  - q: "Is ethnobotany only about indigenous peoples?"
    a: "No. While indigenous and traditional knowledge is central to the field, ethnobotany studies plant-human relationships across all cultures, including modern urban populations. Research on home gardens, farmers' markets, herbal supplements, urban foraging, and cultural food traditions all fall within ethnobotany's scope."
  - q: "What are the ethical concerns in ethnobotany?"
    a: "The biggest concern is biopiracy — when companies profit from traditional plant knowledge without compensating the communities that developed it. The 2010 Nagoya Protocol addresses this by requiring fair benefit-sharing when genetic resources and traditional knowledge are used commercially. Modern ethnobotanists follow strict ethical protocols around informed consent, intellectual property, and benefit-sharing."
---
...
Ethnobotany studies this two-way relationship. Not just what plants exist (that's [botany](/botany)) and not just what people believe (that's anthropology), but the space where humans and plants have co-evolved, co-adapted, and co-created meaning.
...
**Phytochemical analysis:** When a plant is used medicinally, [biochemistry](/biochemistry) comes in — researchers analyze the plant's chemical composition to identify active compounds that might explain its reported effects. This is where ethnobotany meets drug discovery.

**Remote sensing and GIS:** Mapping the spatial distribution of plant resources and their relationship to human settlements and land use patterns. This connects ethnobotany to field ecology and [conservation biology](/conservation-biology).
...
**Biocultural conservation:** Recognizing that biological diversity and cultural diversity are linked, and that conserving one often requires conserving the other. This integrated approach is gaining traction in [conservation biology](/conservation-biology) and international policy.
