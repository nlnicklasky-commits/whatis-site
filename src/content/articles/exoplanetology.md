...
slug: exoplanetology
description: "Exoplanetology is the branch of astronomy and planetary science devoted to the study of exoplanets — planets that orbit stars other than our Sun."
category: science
...
wordCount: 2413
tier: "2"
relatedArticles: ["astronomy", "astrophysics", "cosmology", "biology", "chemistry"]
externalSources:
  ...
  - title: "ESA - Exoplanet Missions"
    url: "https://www.esa.int/Science_Exploration/Space_Science/Exoplanets"
  - title: "Kepler and K2 Missions - NASA"
    url: "https://www.nasa.gov/mission_pages/kepler/main/index.html"
faq:
  - q: "How many exoplanets have been discovered?"
    a: "As of early 2026, over 5,700 exoplanets have been confirmed, with thousands more candidates awaiting verification. The Kepler space telescope alone identified over 2,600 confirmed planets. The pace of discovery continues to accelerate thanks to missions like TESS and the James Webb Space Telescope."
  ...
  - q: "What is the closest known exoplanet to Earth?"
    a: "Proxima Centauri b, orbiting the nearest star to our Sun (Proxima Centauri), at a distance of about 4.24 light-years. It's roughly Earth-sized and sits within the habitable zone, though its host star is a red dwarf that produces intense stellar flares, which may strip away any atmosphere."
  - q: "Can we travel to exoplanets?"
    a: "Not with current technology. Even the closest known exoplanet, Proxima Centauri b, is 4.24 light-years away. At the speed of the fastest spacecraft ever launched (Parker Solar Probe, about 430,000 mph), the trip would take over 6,000 years. Concepts like light sails, nuclear propulsion, and the Breakthrough Starshot initiative aim to reduce travel times to decades, but these remain in early research stages."
---
...
The reality is probably that multiple formation mechanisms operate, with the outcomes depending on disk mass, composition, stellar properties, and the chaotic dynamics of multi-body gravitational interactions. [Astrophysics](/astrophysics) modeling of these processes is computationally demanding but increasingly sophisticated.
...
1. Find planets in habitable zones (done — we've found many)
2. Determine which have atmospheres (in progress — JWST and future missions)
3. Characterize those atmospheres for biosignatures (beginning — JWST is making first measurements)
4. If biosignatures are found, determine whether biological or non-biological explanations are more likely (future work — requires understanding "false positives")
...
Exoplanetology connects to [chemistry](/chemistry) through atmospheric characterization and planet formation. It links to [biology](/biology) through the search for life and understanding habitability. [Cosmology](/cosmology) provides the context of how planetary systems fit into the broader universe. Even [data science](/data-science) is relevant — processing the massive datasets from space telescopes requires sophisticated statistical and machine learning techniques.
