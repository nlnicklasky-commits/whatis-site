...
description: "Forensic science applies scientific methods to criminal and civil investigations, from DNA analysis and fingerprinting to toxicology and digital evidence."
category: science
...
heroAlt: "A woman wearing a white lab coat and safety goggles, standing in a laboratory setting"
...
wordCount: 2810
tier: "2"
relatedArticles: ["chemistry", "biology", "digital-forensics", "anthropology", "cognitive-bias"]
externalSources:
  - title: "National Institute of Justice — Forensic Science"
    url: "https://nij.ojp.gov/forensic-science"
  - title: "FBI Laboratory Services"
    url: "https://www.fbi.gov/services/laboratory"
  - title: "NIST Organization of Scientific Area Committees for Forensic Science"
    url: "https://www.nist.gov/osac"
  - title: "National Academy of Sciences — Strengthening Forensic Science in the United States"
    url: "https://nap.nationalacademies.org/catalog/12589/strengthening-forensic-science-in-the-united-states-a-path-forward"
faq:
  - q: "How reliable is forensic science?"
    a: "Reliability varies dramatically by discipline. DNA analysis is highly reliable with strong scientific foundations and known error rates. Fingerprint analysis has a solid track record but historically lacked standardized error rate studies. Other disciplines — bite mark analysis, hair comparison, footwear analysis — have been criticized for lacking rigorous scientific validation. A landmark 2009 National Academy of Sciences report called for significant reforms across many forensic disciplines."
  - q: "Can DNA evidence be wrong?"
    a: "The DNA analysis itself is extremely accurate, but errors can occur in sample collection (contamination), handling (mislabeling), interpretation (mixed profiles), and database searches (coincidental matches in large databases). Human error, not scientific failure, accounts for most DNA-related mistakes. Proper chain of custody and quality controls are essential."
  - q: "What is the CSI effect?"
    a: "The CSI effect is the belief that television crime dramas have influenced juror expectations about forensic evidence. Some prosecutors report that jurors expect extensive forensic testing in every case and may acquit when such evidence isn't presented, even when other evidence is strong. Research on whether this effect actually exists is mixed, but it has influenced how both sides present cases."
  - q: "How long can DNA evidence last?"
...
## The Role of [Cognitive Bias](/cognitive-bias)
