...
wordCount: 934
tier: "3"
relatedArticles: ["flute", "guitar", "folk-music"]
externalSources:
  - title: "International Horn Society"
    url: "https://www.hornsociety.org/"
  - title: "Britannica — French Horn"
    url: "https://www.britannica.com/art/French-horn"
  - title: "Berlin Philharmonic — Instruments"
    url: "https://www.berliner-philharmoniker.de/"
faq:
  - q: "Why is it called the French horn?"
    a: "The name 'French horn' is primarily used in English-speaking countries and is somewhat misleading. The modern horn was actually developed in Germany. In most other languages, it's simply called 'horn' (Horn in German, cor in French). The International Horn Society has recommended dropping 'French' from the name, and many musicians now simply say 'horn.'"
  - q: "Why is the French horn considered the hardest brass instrument?"
    a: "The horn's harmonic series is very close together in the playing range, meaning tiny changes in embouchure (lip position) can produce completely wrong notes. The tube is over 12 feet long when uncoiled, and the player's hand inside the bell affects intonation. Professional horn players routinely use high harmonics where the margin for error is extremely small."
  - q: "What is the range of the French horn?"
    a: "The French horn has one of the widest ranges of any brass instrument — roughly 3.5 octaves from low B-flat below the bass clef to high F above the treble clef. Professional players extend this range further in both directions. Horn parts are written in F, sounding a perfect fifth lower than written."
---
