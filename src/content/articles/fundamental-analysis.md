...
description: "Fundamental analysis evaluates a stock's true value by studying financial statements, industry conditions, and economic factors. Here's how it works."
category: finance
...
wordCount: 2611
tier: "2"
relatedArticles: ["corporate-finance", "accounting", "budgeting", "capitalism", "data-analysis"]
externalSources:
  ...
  - title: "Aswath Damodaran — Valuation Resources"
    url: "https://pages.stern.nyu.edu/~adamodar/"
faq:
  - q: "What is the difference between fundamental analysis and technical analysis?"
    a: "Fundamental analysis evaluates a company's intrinsic value by studying its financial health, competitive position, and economic environment. Technical analysis studies price charts and trading patterns to predict future price movements. Fundamental analysts ask 'what is this company worth?' Technical analysts ask 'where is the price going next?' Many investors use both."
  - q: "How long does it take to do fundamental analysis on a stock?"
    a: "A thorough fundamental analysis of a single company typically takes 10-40 hours, depending on the company's complexity and the analyst's experience. This includes reading financial statements, understanding the business model, analyzing competitors, and building valuation models. Quick screens can narrow a universe of stocks in hours, but deep analysis takes time."
  - q: "Can fundamental analysis predict stock prices?"
    a: "Fundamental analysis estimates what a stock should be worth based on the company's financials and prospects — not where the price will go tomorrow. Markets can remain irrational for months or years, and fundamentally undervalued stocks can stay cheap or get cheaper. Over longer periods (3-5+ years), stock prices tend to converge toward fundamental value, but timing is unpredictable."
  - q: "Is fundamental analysis still useful with algorithmic trading?"
    a: "Yes. Algorithmic trading has made markets more efficient at processing public information quickly, but fundamental analysis still works because understanding a business requires judgment that algorithms struggle with. Long-term investors like Warren Buffett, Seth Klarman, and Howard Marks continue to outperform using fundamental approaches."
---
...
Financial statements are the raw material of fundamental analysis. Public companies file them quarterly (10-Q) and annually (10-K) with the SEC, and they're freely available on [EDGAR](https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany). Here's what to look for.
...
**The catch**: Net income can be manipulated. [Accounting](/accounting) rules allow significant discretion in recognizing revenue, timing expenses, and classifying items as one-time charges. A single quarter's net income can be misleading. Look at trends over multiple years.
...
Past performance is informative but not predictive. A company that grew 20% annually for five years might grow 5% going forward if its market is saturating. Financial statements tell you what happened. [Business strategy](/business-strategy) analysis tells you what might happen next.
...
Credit rating agencies (Moody's, S&P, Fitch) perform fundamental analysis and assign ratings. But the 2008 financial crisis demonstrated that ratings can be dangerously wrong — [corporate finance](/corporate-finance) professionals who did their own analysis would have spotted problems that the agencies missed.
