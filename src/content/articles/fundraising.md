...
slug: fundraising
description: "Fundraising is the organized effort to collect voluntary contributions for a cause. Learn about strategies, methods, donor psychology, and best practices."
category: finance
...
wordCount: 2519
tier: "2"
relatedArticles: ["budgeting", "digital-marketing", "business-strategy", "accounting", "data-analysis"]
externalSources:
  - title: "Association of Fundraising Professionals"
    url: "https://afpglobal.org/"
  - title: "Giving USA Annual Report"
    url: "https://givingusa.org/"
  - title: "Chronicle of Philanthropy"
    url: "https://www.philanthropy.com/"
  - title: "National Council of Nonprofits"
    url: "https://www.councilofnonprofits.org/running-nonprofit/fundraising-and-resource-development"
faq:
  - q: "What percentage of donations should go to fundraising costs?"
    a: "The industry standard is that nonprofits should spend no more than 15-25% of their budget on fundraising. However, this metric can be misleading — a new organization investing heavily in donor acquisition may have higher costs that pay off over time. The Better Business Bureau's Wise Giving Alliance recommends that at least 65% of total expenses go to program activities."
  - q: "What is the most effective fundraising method?"
    a: "Face-to-face solicitation consistently produces the highest response rates and largest average gifts, particularly for major donor cultivation. For volume, email campaigns and peer-to-peer fundraising are most efficient. The most effective overall strategy combines multiple methods — direct asks for major donors, events for community building, and digital campaigns for broad reach."
  - q: "How much do Americans donate to charity annually?"
    a: "Americans donated approximately $557 billion to charity in 2023, according to Giving USA. Individuals account for about 67% of all giving, followed by foundations (19%), bequests (9%), and corporations (5%). Religious organizations receive the largest share (27%), followed by education (14%) and human services (13%)."
  - q: "Do donors need a tax receipt for their donation?"
    a: "In the U.S., donors need a written acknowledgment from the charity for any single donation of $250 or more to claim a tax deduction. For donations under $250, a bank record or receipt is sufficient. The acknowledgment must include the amount, whether goods or services were provided in exchange, and the organization's tax-exempt status."
---
...
Grant writing is a specialized skill. Good grant writers combine clear writing, logical program design, credible [budgeting](/budgeting), and an understanding of what funders want to see. Many organizations hire dedicated grant writers or consultants.
...
**Email campaigns** remain the workhorse of [digital marketing](/digital-marketing) for nonprofits. Segmented, personalized emails to existing donors consistently outperform other digital channels for direct solicitation.
...
[Data analysis](/data-analysis) tools make segmentation increasingly sophisticated. Predictive modeling can identify donors most likely to increase their giving, most likely to lapse, or most likely to include the organization in their estate plans.
...
- Accurate financial reporting and [accounting](/accounting)
