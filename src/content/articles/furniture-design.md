---
title: "What Is Furniture Design?"
...
wordCount: 888
tier: "3"
relatedArticles: ["furniture-making", "graphic-design", "fashion-design"]
externalSources:
  - title: "Museum of Modern Art — Design Collection"
    url: "https://www.moma.org/collection/departments/architecture-design"
  - title: "Cooper Hewitt Design Museum"
    url: "https://www.cooperhewitt.org/"
  - title: "Design Museum London"
    url: "https://designmuseum.org/"
faq:
  - q: "What is the difference between furniture design and furniture making?"
    a: "Furniture design is the creative process of conceiving a piece — its form, function, materials, and aesthetics. Furniture making (or woodworking/cabinetmaking) is the physical construction. A designer might never touch wood; a maker might build from someone else's designs. Some professionals do both, but in industry, the roles are typically separate."
...
Designing furniture is harder than most people assume. A chair, for example, must support a human body (which varies wildly in size and shape) in multiple positions (sitting upright, leaning back, shifting weight) for extended periods without causing discomfort. It must be structurally sound enough to withstand years of daily use. It must be constructed from available materials using feasible manufacturing methods. And it must look appropriate in its intended setting.

Getting all of these right simultaneously is genuinely difficult. There's a reason that the chair is considered the ultimate design challenge — more iconic chair designs exist than any other furniture type, and designers have been trying to perfect the chair for thousands of years without reaching a definitive solution.
...
**Production.** For mass production, the manufacturer refines the design for efficient manufacturing. For craft production, the maker interprets the design through their skills and workshop capabilities.

## Ergonomics

Good furniture design starts with the human body — its dimensions, movements, and comfort requirements.

**Seat height** for dining chairs is typically 17-19 inches (matching standard table heights of 28-30 inches). Office chairs need adjustability because users vary. Lounge chairs sit lower (14-17 inches) to encourage reclining.
