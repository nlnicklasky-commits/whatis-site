...
slug: genetics
description: "Genetics studies genes, heredity, and variation in living organisms — from DNA structure to gene editing, inheritance patterns, and modern biotechnology."
category: science
tags: ["genetics", "genes", "dna", "heredity", "molecular biology", "biotechnology", "evolution"]
heroImage: "/images/articles/genetics-hero.webp"
heroAlt: "Genetics studies genes, heredity, and variation in living organisms — from DNA structure to gene editing"
...
wordCount: 2826
tier: "2"
relatedArticles: ["biology", "biochemistry", "biotechnology", "cell-biology", "developmental-biology"]
externalSources:
  - title: "National Human Genome Research Institute"
    url: "https://www.genome.gov/"
  - title: "Genetics — Nature Education"
    url: "https://www.nature.com/scitable/topic/genetics-702/"
  - title: "CRISPR Gene Editing — NIH"
    url: "https://www.genome.gov/about-genomics/policy-issues/Genome-Editing/How-genome-editing-works"
  - title: "Human Genome Project — NIH"
    url: "https://www.genome.gov/human-genome-project"
  - title: "Mendelian Genetics — Khan Academy"
    url: "https://www.khanacademy.org/science/biology/classical-genetics"
faq:
  - q: "What is the difference between genetics and genomics?"
    a: "Genetics studies individual genes and their roles in inheritance. Genomics studies entire genomes — all of an organism's DNA — including how genes interact with each other and the environment. Think of genetics as studying individual words and genomics as analyzing the whole book."
  - q: "Can your genes change during your lifetime?"
    a: "Your DNA sequence is mostly fixed from birth, but mutations can occur from environmental exposures, errors during cell division, or aging. Additionally, epigenetic changes — chemical modifications that affect gene expression without altering the DNA sequence — happen constantly throughout your life in response to diet, stress, and environment."
  - q: "What percentage of DNA do humans share with each other?"
    a: "All humans share about 99.9% of their DNA. The 0.1% difference — roughly 3 million base pairs out of 3 billion — accounts for the variation in traits like eye color, disease susceptibility, and other individual characteristics."
  - q: "Is gene editing safe?"
    a: "CRISPR and other gene-editing technologies show enormous promise but carry risks including off-target edits (cutting DNA in unintended locations), mosaicism (where only some cells receive the edit), and unknown long-term effects. The technology is advancing rapidly, but editing human embryos remains highly controversial and is banned or restricted in most countries."
---

# What Is Genetics?

Genetics is the branch of [biology](/biology) that studies genes, heredity, and genetic variation in living organisms. It explains how traits are passed from parents to offspring through DNA, how genetic information is encoded and expressed, and how variations in genes contribute to the diversity of life on Earth.
...
The project also revealed that humans have far fewer genes than expected. Early estimates predicted 100,000 genes. The actual number — roughly 20,000-25,000 — is comparable to much simpler organisms. The complexity of human [biology](/biology) comes not from having more genes but from more sophisticated gene regulation, alternative splicing (one gene producing multiple proteins), and complex protein interactions.
...
**Research**: CRISPR has accelerated basic research enormously. Scientists can now knock out genes in model organisms in weeks rather than years, enabling faster understanding of gene function in [developmental biology](/developmental-biology) and [biochemistry](/biochemistry).
...
These forces, operating on genetic variation over millions of years, produced the remarkable diversity of life described by [biology](/biology) and studied through [computational biology](/computational-biology) approaches.
