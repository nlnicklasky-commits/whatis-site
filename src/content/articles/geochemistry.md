...
slug: geochemistry
description: "Geochemistry is the scientific discipline that uses chemistry principles to study the composition, structure."
category: science
...
wordCount: 2336
tier: "2"
relatedArticles: ["chemistry", "crystallography", "climatology", "biochemistry", "agriculture"]
externalSources:
  - title: "Geochemistry — USGS"
    url: "https://www.usgs.gov/mission-areas/water-resources/science/geochemistry"
  - title: "Geochemical Society"
    url: "https://www.geochemsoc.org/"
  - title: "Goldschmidt Conference"
    url: "https://www.goldschmidt.info/"
  - title: "Geochemistry — Britannica"
    url: "https://www.britannica.com/science/geochemistry"
  - title: "IAGC — International Association of GeoChemistry"
    url: "https://www.iagc-society.org/"
faq:
  - q: "What is the difference between geochemistry and chemistry?"
    a: "Chemistry studies chemical reactions and properties of matter in general. Geochemistry applies chemical principles specifically to Earth systems — rocks, water, atmosphere, and living organisms — to understand how elements distribute, cycle, and transform in natural settings. It's chemistry with a geological context."
  - q: "What do geochemists actually do day to day?"
    a: "Geochemists collect field samples (rocks, water, soil, gas), analyze them using instruments like mass spectrometers and X-ray fluorescence analyzers, interpret the data to understand geological processes, and build models of how elements move through Earth systems. They work in labs, in the field, and on computers."
  - q: "How does geochemistry help find oil and minerals?"
    a: "Geochemists analyze soil, water, and rock chemistry to identify signatures that indicate ore deposits or petroleum reservoirs. Specific element ratios, isotope patterns, and trace element concentrations can reveal subsurface resources without extensive drilling, reducing exploration costs significantly."
  - q: "Can geochemistry help with climate change research?"
    a: "Absolutely. Geochemists analyze ice cores, ocean sediments, and rock formations to reconstruct past climates over millions of years. They track carbon cycling through Earth systems, study ocean acidification chemistry, and help model how the planet responds to changes in greenhouse gas concentrations."
---

# What Is Geochemistry?

Geochemistry is the scientific discipline that uses [chemistry](/chemistry) principles to study the composition, structure, and chemical processes of the Earth and other planetary bodies. It examines how chemical elements distribute themselves among rocks, minerals, water, the atmosphere, and living organisms — and how they cycle through these systems over geological time.
...
Volcanic eruptions bring mantle material to the surface. Certain [crystallography](/crystallography) patterns in minerals called xenoliths — chunks of mantle rock carried up by erupting magma — tell us the mantle is dominated by olivine, pyroxene, and garnet. Seismic wave analysis reveals density and elastic properties consistent with iron- and magnesium-rich silicates.
...
Human burning of fossil fuels has transferred carbon from the long-term geological reservoir to the atmosphere roughly 100 times faster than volcanic emissions. Understanding this through geochemistry is central to [climatology](/climatology) and climate science.
