...
slug: geopolitics
description: "Geopolitics is the study of how geography — physical terrain, natural resources, climate, and location — shapes the power, strategy."
category: history
...
externalSources:
  ...
  - title: "U.S. Department of State — Foreign Policy"
    url: "https://www.state.gov/policy-issues/"
  - title: "Carnegie Endowment for International Peace"
    url: "https://carnegieendowment.org/"
  - title: "Britannica: Geopolitics"
    url: "https://www.britannica.com/topic/geopolitics"
faq:
  - q: "What is the difference between geopolitics and political science?"
  ...
  - q: "Why are straits and canals so important in geopolitics?"
    a: "Maritime chokepoints like the Strait of Hormuz, Strait of Malacca, Suez Canal, and Panama Canal are narrow waterways through which enormous volumes of global trade must pass. About 20% of the world's oil flows through the Strait of Hormuz. Any disruption to these passages — through war, piracy, or political conflict — can spike global energy prices and disrupt supply chains worldwide."
  - q: "Is geopolitics the same as Realpolitik?"
    a: "They overlap but aren't identical. Realpolitik refers to pragmatic, power-based diplomacy unconcerned with ideology or morality — it's a philosophy of how to conduct foreign policy. Geopolitics is an analytical framework that emphasizes geography's role in international power. A leader practicing Realpolitik might use geopolitical analysis, but geopolitics as a field of study isn't inherently prescriptive."
  - q: "How does climate change affect geopolitics?"
    a: "Climate change is reshaping geopolitics in multiple ways: melting Arctic ice is opening new shipping routes and resource extraction zones, creating territorial disputes; water scarcity is intensifying conflicts in the Middle East and Central Asia; rising seas threaten island nations and coastal megacities; and the transition away from fossil fuels is shifting the balance of power away from oil-producing states."
---
...
Throughout [history](/cartography), great powers have sought buffer zones — territories between themselves and potential adversaries. Ukraine between Russia and NATO. Afghanistan between the British and Russian empires (the "Great Game"). Korea between China and Japan.
