---
title: "What Is the Greek Language?"
slug: greek-language
...
wordCount: 1018
tier: "3"
relatedArticles: ["grammar", "greek-mythology", "linguistics"]
externalSources:
  - title: "Linguistic Society of America — Greek"
    url: "https://www.linguisticsociety.org/"
  - title: "Encyclopaedia Britannica — Greek Language"
    url: "https://www.britannica.com/topic/Greek-language"
  - title: "Perseus Digital Library — Ancient Greek Texts"
    url: "https://www.perseus.tufts.edu/"
faq:
  - q: "How old is the Greek language?"
    a: "Greek has the longest documented history of any Indo-European language. The earliest known Greek writing dates to around 1450 BCE (Linear B tablets from Mycenaean civilization). The Greek alphabet has been in continuous use since about 800 BCE. That's over 3,400 years of recorded Greek — no other European language comes close."
  - q: "Can modern Greeks understand ancient Greek?"
    a: "Partially. Modern Greek speakers can recognize many ancient Greek words and understand simple ancient texts with effort, but fluent reading of classical authors like Plato or Homer requires dedicated study — roughly comparable to an English speaker reading Chaucer's Middle English. Grammar, pronunciation, and many word meanings have changed significantly over 2,500 years."
  - q: "How many English words come from Greek?"
    a: "Approximately 30% of English words have Greek origins, though the proportion is much higher in scientific, medical, and technical vocabulary — possibly 60-70% in those fields. Words like 'democracy,' 'philosophy,' 'biology,' 'telephone,' 'psychology,' and 'technology' are all Greek. English continues to coin new words from Greek roots (e.g., 'podcast' from 'pod' uses a Greek-derived element)."
---
...
**Koine Greek** (roughly 300 BCE-300 CE) was the common dialect that spread across Alexander the Great's empire. It simplified earlier Greek [grammar](/grammar) and became the lingua franca of the eastern Mediterranean and Near East. The New Proof was written in Koine Greek. So were the earliest translations of the Hebrew Bible (the Septuagint).
...
**Direct borrowings** — words taken straight from Greek: analysis, crisis, [drama](/drama), idea, music, theme, zone.

**Scientific terminology** — biology (bios + logos = life + study), [psychology](/psychology) (psyche + logos = mind + study), [geology](/geology), [astronomy](/astronomy), [physics](/physics), [mathematics](/mathematics). When scientists need a new term, they almost always build it from Greek (or Latin) roots.

**Medical vocabulary** — cardiology, [dermatology](/dermatology), [pathology](/pathology), diagnosis, prognosis, therapy, symptom. [Medical terminology](/medical-terminology) is so Greek-heavy that learning Greek roots is literally part of medical [education](/education).
...
**Philosophy** — Plato's dialogues and Aristotle's treatises were written in Greek that's still studied in the original. Their vocabulary became the vocabulary of Western thought: [logic](/logic), [metaphysics](/metaphysics), [ethics](/ethics), [politics](/politics), [aesthetics](/aesthetics).
