...
A cyclic group is generated by a single element—every element can be expressed as a power (or repeated application) of one generator. The group of integers modulo 7 under addition is cyclic: starting from 1 and adding repeatedly gives you 1, 2, 3, 4, 5, 6, 0, 1, 2, ... [cycling](/cycling) through all elements.
...
The largest sporadic group—called the Monster—has approximately 8 x 10^53 elements. Its connections to number theory and [string theory](/string-theory) (a mysterious relationship called "monstrous moonshine") won Richard Borcherds the Fields Medal in 1998.
...
- Symmetry under time [translation](/translation) (physics works the same today as tomorrow) gives conservation of energy
...
- Which electronic transitions are "allowed" (high probability) versus "forbidden" (low probability) in [spectroscopy](/spectroscopy)
