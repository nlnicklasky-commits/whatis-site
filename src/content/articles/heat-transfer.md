...
slug: heat-transfer
description: "Heat transfer is the movement of thermal energy between objects or systems due to temperature differences — conduction, convection, and radiation explained."
category: science
...
heroAlt: "A glass container with a boiling liquid, likely a reaction or experiment in progress. The background is blurred, but there"
...
wordCount: 2973
tier: "2"
relatedArticles: ["classical-mechanics", "chemical-engineering", "civil-engineering", "climatology", "air-conditioning"]
externalSources:
  - title: "MIT OpenCourseWare - Heat Transfer"
    url: "https://ocw.mit.edu/courses/2-51-intermediate-heat-and-mass-transfer-fall-2008/"
  - title: "NASA - Heat Transfer"
    url: "https://www.grc.nasa.gov/www/k-12/airplane/heat.html"
  - title: "Engineering Toolbox - Heat Transfer"
    url: "https://www.engineeringtoolbox.com/heat-transfer-coefficients-d_412.html"
  - title: "NIST Thermophysical Properties"
    url: "https://www.nist.gov/srd/nist-standard-reference-database-23"
faq:
  - q: "What are the three types of heat transfer?"
    a: "The three modes of heat transfer are conduction (direct contact between molecules), convection (heat carried by moving fluids like air or water), and radiation (energy transmitted as electromagnetic waves, requiring no medium). Most real-world situations involve all three modes simultaneously, though one typically dominates."
  - q: "Why does metal feel colder than wood at the same temperature?"
    a: "Metal and wood at room temperature are actually the same temperature, but metal has much higher thermal conductivity—it conducts heat away from your warm hand about 1,000 times faster than wood. Your skin senses the rate of heat loss, not the actual temperature of the surface. This is why metal feels cold and wood feels warm, even though both are 20 degrees Celsius."
  - q: "How does a thermos bottle work?"
...
Forced convection is also how most buildings are heated and cooled. A furnace heats air; a blower pushes it through ducts to every room. An [air conditioning](/air-conditioning) system chills air; fans distribute it. The heat transfer happens by convection, but it's forced convection—controlled and directed.
