---
title: "What Is Historical Weaponry?"
slug: historical-weaponry
...
wordCount: 1735
tier: "3"
relatedArticles: ["military-history", "archaeology", "medieval-history", "the-history-of-astronomy", "the-history-of-biology"]
externalSources:
  ...
  - title: "Smithsonian National Museum of American History: Military Collections"
    url: "https://americanhistory.si.edu/topics/military-diplomatic-history"
  - title: "UNESCO: Intangible Cultural Heritage and Traditional Craftsmanship"
    url: "https://ich.unesco.org/en/traditional-craftsmanship-00057"
  - title: "National Archives: Military Records"
    url: "https://www.archives.gov/research/military"
faq:
  - q: "What was the most important weapon in ancient warfare?"
    a: "The spear. It was cheap to produce, easy to learn, and effective in formation combat. From Greek hoplite phalanxes to Zulu impis, spears dominated battlefields for thousands of years — far longer than any other single weapon type."
  - q: "When were firearms first used in warfare?"
    a: "The earliest firearms appeared in China during the 13th century. The 'fire lance,' a gunpowder-filled tube attached to a spear, saw use as early as the 10th century. By the 1300s, metal-barreled guns were being used in both China and Europe."
  - q: "Did medieval swords actually weigh a lot?"
    a: "No. A typical one-handed medieval arming sword weighed between 1 and 1.5 kilograms (roughly 2 to 3 pounds). Even large two-handed greatswords rarely exceeded 3 kilograms. Hollywood has given people the impression that swords were impossibly heavy, but they were actually well-balanced tools designed for speed and control."
  - q: "What is Damascus steel?"
    a: "Damascus steel refers to a type of crucible steel produced in the Middle East, famous for its distinctive wavy pattern and reputation for exceptional sharpness and strength. The original production techniques were lost around the 18th century, and modern 'Damascus steel' is typically pattern-welded steel that mimics the visual appearance."
---

# What Is Historical Weaponry?
...
By the Neolithic period (roughly 10,000 BCE onward), weaponry started getting more sophisticated. Flint arrowheads, polished stone mace heads, and obsidian blades appeared. Obsidian — volcanic glass — can be knapped to an edge sharper than modern surgical steel. Some [archaeology](/archaeology) sites have uncovered obsidian blades with edges just a few nanometers wide.
...
The relationship between weapons and armor is essentially an arms race that spans all of human [military history](/military-history). Every improvement in offensive capability drives improvements in defense, and vice versa. This cycle has never really stopped.
...
The response was the trace italienne — star-shaped fortifications with low, thick, angled walls designed to deflect cannon fire. These new fortifications worked, but they were enormously expensive. Only wealthy states could afford them, which concentrated [military](/military-history) power among major nations and helped drive the formation of modern nation-states.
