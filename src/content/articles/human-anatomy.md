...
slug: human-anatomy
description: "Human anatomy is the scientific study of the body's physical structures — from the macroscopic arrangement of organs and bones down to the microscopic."
category: science
...
wordCount: 2970
tier: "2"
relatedArticles: ["anatomy", "biology", "cell-biology", "biomechanics", "developmental-biology"]
externalSources:
  - title: "Visible Human Project — National Library of Medicine"
    url: "https://www.nlm.nih.gov/research/visible/visible_human.html"
  - title: "Gray's Anatomy Online — Elsevier"
    url: "https://www.elsevier.com/books/grays-anatomy/standring/978-0-7020-7705-0"
  - title: "NIH SEER Training — Introduction to the Human Body"
    url: "https://training.seer.cancer.gov/anatomy/"
  - title: "Anatomical Terminology — Federative International Programme for Anatomical Terminology"
    url: "https://fipat.library.dal.ca/"
faq:
  - q: "What is the difference between anatomy and physiology?"
    a: "Anatomy studies the structure of body parts — their shape, size, location, and relationships to each other. Physiology studies how those parts function. They're closely related: structure often determines function (for instance, the shape of a bone joint determines the range of motion it allows), and most courses teach both together."
  ...
  - q: "Why do medical students still dissect cadavers?"
  ...
  - q: "What is the largest organ in the human body?"
    a: "The skin. In an average adult, it covers roughly 20 square feet (about 1.9 square meters) and weighs approximately 8 pounds. It functions as a barrier against infection, regulates body temperature, synthesizes vitamin D, and houses nerve receptors for touch, pressure, pain, and temperature."
---

# What Is Human Anatomy?

Human anatomy is the scientific study of the body's physical structures — from the macroscopic arrangement of organs and bones down to the microscopic organization of tissues and cells. It is one of the foundational disciplines of medicine and [biology](/biology), providing the structural map without which understanding health, disease, and treatment would be impossible.
...
Joints — where bones meet — come in several types. Synovial joints (knees, shoulders, hips) allow extensive movement and are lined with cartilage to reduce friction. Fibrous joints (skull sutures) allow almost no movement. Cartilaginous joints (intervertebral discs) allow limited motion. The design of each joint reflects its function — a principle called structure-function relationship that runs through all of [anatomy](/anatomy).
...
The smallest functional unit of skeletal muscle is the sarcomere — a repeating arrangement of actin and myosin proteins that slide past each other to create contraction. This sliding filament mechanism, worked out in the 1950s by Hugh Huxley and Jean Hanson, is one of [cell biology](/cell-biology)'s most elegant explanations.
...
**CT scanning** (developed in the 1970s) takes multiple X-ray images from different angles and uses [algorithms](/algorithms) to construct cross-sectional images. A modern CT scanner can image the entire body in seconds, producing detailed 3D reconstructions.
...
[Developmental biology](/developmental-biology) intersects with anatomy in understanding how the body's structure emerges. A single fertilized egg divides and differentiates into over 200 cell types, organized into tissues, organs, and organ systems — all in about 9 months.
