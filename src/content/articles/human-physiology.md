...
description: "Human physiology is the scientific study of how the human body functions — not what structures exist (that's anatomy), but how those structures work."
category: science
...
wordCount: 2682
tier: "2"
relatedArticles: ["biology", "cell-biology", "biochemistry", "anatomy", "developmental-biology"]
externalSources:
  - title: "American Physiological Society"
    url: "https://www.physiology.org/"
  - title: "NIH National Institute of General Medical Sciences — Physiology"
    url: "https://nigms.nih.gov/"
  - title: "Guyton and Hall Textbook of Medical Physiology"
    url: "https://www.elsevier.com/books/guyton-and-hall-textbook-of-medical-physiology/hall/978-0-323-59712-8"
  - title: "The Physiological Society (UK)"
    url: "https://www.physoc.org/"
faq:
  - q: "What is the difference between anatomy and physiology?"
    a: "Anatomy studies structure — where body parts are and what they look like. Physiology studies function — how those parts work and interact. A cardiologist who knows anatomy can identify the heart's chambers and valves; understanding physiology tells them how blood flows through those chambers, what makes the heart beat, and how cardiac output adjusts during exercise."
  - q: "What is homeostasis and why is it important?"
    a: "Homeostasis is the body's ability to maintain stable internal conditions despite changes in the external environment. Body temperature stays near 37 degrees Celsius whether it's freezing or sweltering outside. Blood glucose stays within a narrow range despite variable food intake. Nearly every physiological system contributes to homeostasis, and most diseases can be understood as failures of homeostatic regulation."
  - q: "How does physiology differ from biochemistry?"
    a: "Biochemistry studies chemical reactions within cells — enzyme kinetics, metabolic pathways, protein structure, DNA replication. Physiology studies how cells, tissues, organs, and organ systems function as integrated units. A biochemist might study how ATP is produced; a physiologist asks how ATP production changes during exercise and how that affects muscle performance, breathing rate, and heart output."
  - q: "What careers use human physiology?"
...
**Systems physiology** uses computational modeling to simulate how organ systems interact. Rather than studying one system in isolation, [computational biology](/computational-biology) approaches model the entire organism — predicting how a drug that affects the liver might secondarily impact the kidneys, heart, and brain.
