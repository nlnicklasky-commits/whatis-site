---
title: "What Is Invention?"
slug: invention
description: "Invention is the creation of something genuinely new — a device, process, or method that didn't exist before — through problem-solving and experimentation."
category: technology
...
heroAlt: "Invention is the creation of something genuinely new — a device, process, or method that didn't exist before — through problem-solving and experimentation"
...
Ideas on paper are cheap. Making them work in reality is where the hard [engineering](/engineering) happens.
...
1. **Novel** — it hasn't been done before
2. **Non-obvious** — a person skilled in the field wouldn't consider it an obvious modification of existing technology
3. **Useful** — it actually works and has practical application
...
The steam engine converted heat into mechanical work, freeing [humanity](/engineering) from dependence on muscle power, wind, and water for the first time. It powered the Industrial Revolution, which transformed every aspect of economic and social life in ways that are still playing out.
