...
wordCount: 1833
tier: "3"
relatedArticles: ["law", "philosophy", "archaeology"]
externalSources:
  - title: "American Society for Legal History"
    url: "https://aslh.net/"
  - title: "Yale Law School — Legal History Resources"
    url: "https://law.yale.edu/library"
  - title: "Stanford Encyclopedia of Philosophy — Philosophy of Law"
    url: "https://plato.stanford.edu/entries/lawphil-nature/"
  - title: "Library of Congress — Legal Research Guides"
    url: "https://guides.loc.gov/law"
faq:
  - q: "Why is legal history important?"
    a: "Legal history reveals why current laws exist, how they've been used for both justice and oppression, and how legal systems adapt to social change. Understanding the origins of legal rules helps lawyers, judges, and citizens evaluate whether those rules still make sense today."
  - q: "What is the oldest known legal code?"
    a: "The Code of Ur-Nammu, dating to roughly 2100-2050 BCE in ancient Sumer, is the oldest surviving legal code. It predates the more famous Code of Hammurabi by about three centuries and includes laws on murder, robbery, and family disputes."
  - q: "How does legal history differ from studying law itself?"
    a: "Studying law focuses on current rules and how to apply them. Legal history examines how and why those rules developed, what social forces shaped them, and how legal thinking has changed over time. It provides context that pure legal analysis cannot."
  - q: "What role did English common law play in global legal history?"
...
While continental Europe built its legal systems on Roman codes, England took a distinctly different path — one that would eventually shape the legal systems of a third of the world's countries.

After the Norman Conquest of 1066, William the Conqueror needed to unify England's patchwork of local customs. Royal judges, traveling on circuit through the country, began applying consistent principles to disputes. Over time, these judicial decisions accumulated into a body of "common law" — law common to the entire kingdom.

The key innovation was precedent. When a judge decided a case, that decision became a guide for future judges facing similar facts. This principle — *stare decisis* (let the decision stand) — meant that law grew organically through individual cases rather than through thorough legislation.

The Magna Carta (1215) was a landmark, though not in the way most people think. It wasn't a democratic document — it was a peace treaty between King John and his rebellious barons. But its principles — no taxation without consent, no imprisonment without lawful judgment, the king is subject to law — became foundational to constitutional thinking. Its influence on the U.S. Constitution and Bill of Rights is direct and well-documented.

English equity law developed alongside common law as a corrective. When common law produced unjust results, parties could petition the king's chancellor for relief. Over time, these equity courts developed their own principles — trusts, injunctions, specific performance — that merged with common law courts in the 19th century but remain conceptually distinct.
...
Canon law — the legal system of the Catholic Church — governed much of European life during the medieval period. Church courts handled marriage, inheritance, moral offenses, and disputes involving clergy. Canon law contributed concepts still present in secular law, including the idea that intent matters in criminal guilt and that contracts should be honored in good faith.

## The Age of Codification

The 18th and 19th centuries brought a dramatic shift: the idea that an entire legal system could be rationally organized and written down in a single, coherent code.

The French Civil Code (1804) — often called the Napoleonic Code — was the most influential product of this movement. Napoleon himself spent hours in drafting sessions, and the result was a relatively clear, concise legal code that ordinary citizens could theoretically read and understand. Its influence spread through French colonies and conquests to Belgium, the Netherlands, Italy, Egypt, Quebec, Louisiana, and Latin America.

The German Civil Code (BGB), enacted in 1900, represented a more scholarly approach — highly systematic, abstract, and technical. It influenced the legal codes of Japan, South Korea, Greece, and Turkey.

Codification was partly about control — states wanted uniform, predictable law throughout their territory. But it was also about [philosophy](/philosophy). Enlightenment thinkers believed reason could produce a perfect legal system, one where every question had a clear answer written in the code. That ambition proved unrealistic, but the codes endure.
...
Today's legal systems face challenges that would have been unimaginable to Hammurabi or Blackstone.
