...
slug: linguistics
description: "Linguistics is the scientific study of language. Learn about phonetics, syntax, semantics, and how linguists decode the systems behind human communication."
category: science
...
wordCount: 2824
tier: "2"
relatedArticles: ["anthropology", "cognitive-psychology", "computational-linguistics", "communication-theory", "artificial-intelligence"]
externalSources:
  - title: "Linguistic Society of America"
    url: "https://www.linguisticsociety.org/what-linguistics"
  - title: "MIT Department of Linguistics"
    url: "https://linguistics.mit.edu/"
  - title: "Wikipedia Linguistics"
    url: "https://en.wikipedia.org/wiki/Linguistics"
  - title: "Stanford Encyclopedia of Philosophy - Philosophy of Language"
    url: "https://plato.stanford.edu/entries/philosophy-language/"
faq:
  - q: "How many languages exist in the world?"
    a: "There are approximately 7,000 languages spoken worldwide today, though the exact count depends on how you distinguish languages from dialects. About 40% of these are endangered, with fewer than 1,000 speakers remaining. A language goes extinct roughly every two weeks."
  - q: "Is linguistics the same as learning languages?"
    a: "No. Linguistics is the scientific study of how language works — its structure, sounds, meaning, and social use. Learning a language (being a polyglot) is a different skill. A linguist might study the grammar of Navajo without speaking it fluently, just as a music theorist might analyze jazz without being a jazz musician."
  - q: "What jobs can you get with a linguistics degree?"
    a: "Linguists work in natural language processing and AI, speech pathology, translation and localization, language teaching, forensic linguistics, computational linguistics, dictionary editing (lexicography), and academic research. Tech companies like Google, Apple, and Amazon hire linguists for voice assistants and search algorithms."
  - q: "Do all languages have grammar?"
    a: "Yes, every human language has grammar — a system of rules governing how sounds, words, and sentences are structured. No language is 'primitive' or lacks grammar. Some languages have very different grammatical structures from English, but all are equally systematic and expressive."
---
