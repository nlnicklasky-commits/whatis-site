...
externalSources:
  ...
  - title: "University of Arizona: Textile Museum"
    url: "https://artmuseum.arizona.edu/"
faq:
  - q: "What is the difference between warp and weft?"
    a: "The warp threads run lengthwise on the loom and are held under tension. The weft threads run crosswise, interlacing over and under the warp threads. The warp is set up first and stays in place throughout the weaving process. The weft is passed through the warp using a shuttle, changing direction at each edge to build up the fabric row by row."
  - q: "What type of loom is best for beginners?"
    a: "A rigid heddle loom is the best starting point. It's relatively affordable ($100-300), compact, and can produce scarves, towels, placemats, and simple yardage. It uses a single heddle that both separates the warp threads and beats the weft into place. You can start weaving within an hour of setup."
