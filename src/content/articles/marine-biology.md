---
title: "What Is Marine Biology?"
slug: marine-biology
description: "Marine biology is the study of ocean life, from microscopic plankton to blue whales, covering ecology, conservation, and how marine ecosystems actually work."
category: science
...
heroAlt: "Marine biology is the study of ocean life, from microscopic plankton to blue whales, covering ecology, conservation, and how marine ecosystems actually work"
...
wordCount: 3051
tier: "1"
relatedArticles: ["ecology", "biology", "conservation-biology", "environmental-science", "freshwater-biology"]
externalSources:
  - title: "NOAA Ocean Service"
    url: "https://oceanservice.noaa.gov/"
  - title: "Smithsonian Ocean Portal"
    url: "https://ocean.si.edu/"
  - title: "Marine Biology Association"
...
Understanding these chemical dynamics connects marine biology to [chemistry](/chemistry) and [environmental chemistry](/environmental-chemistry) in essential ways.
...
We've explored less than 5% of the deep ocean. New species are discovered on virtually every deep-sea expedition. Marine [biology](/biology) still has its frontier, and it's underwater.
...
**Remote sensing**: Satellites track ocean color (indicating phytoplankton concentration), temperature, and sea level. These datasets let researchers study ocean-basin-scale patterns that would be impossible to observe from a single boat. This connects to [data analysis](/data-analysis) and [data visualization](/data-visualization) approaches.
...
**Molecular techniques**: DNA barcoding identifies species from tissue samples. Environmental DNA (eDNA) detects organisms from water samples — you can determine which fish species inhabit a lake or ocean area just by filtering water and sequencing the DNA fragments. [Genetics](/genetics) and genomics reveal population structure, evolutionary relationships, and adaptive mechanisms.
...
**Modeling**: Mathematical and [computational biology](/computational-biology) approaches simulate population dynamics, ocean circulation, species distributions, and ecosystem function. Climate models predict future ocean conditions. Population models assess whether fisheries are sustainable.

### Data Analysis

Modern marine biology is data-intensive. A single research cruise might generate terabytes of acoustic, visual, chemical, and biological data. Making sense of this requires statistical analysis, spatial modeling, and increasingly [machine learning](/machine-learning) approaches for tasks like species identification from images or acoustic recordings.
...
The full ecological impact of marine plastic pollution is still being understood. Marine biologists study ingestion rates, chemical transfer, effects on reproduction and survival, and ecosystem-level consequences. The problem connects to [environmental science](/environmental-science) and [chemistry](/chemistry) because understanding plastic degradation, chemical leaching, and pollutant transport requires interdisciplinary expertise.
...
**Autonomous underwater vehicles** (AUVs) and remotely operated vehicles (ROVs) are extending research into the deep ocean and under ice — environments too dangerous or expensive for human divers. These technologies, combined with [artificial intelligence](/artificial-intelligence) for automated image analysis, are transforming deep-sea biology from an anecdotal science into a quantitative one.
