...
description: "Marine engineering is the branch of engineering that designs, builds, operates, and maintains the mechanical, electrical."
category: technology
...
wordCount: 2755
tier: "2"
relatedArticles: ["engineering", "electrical-engineering", "fluid-dynamics", "aerospace-engineering", "hydraulics"]
externalSources:
  - title: "Society of Naval Architects and Marine Engineers"
    url: "https://www.sname.org/"
  - title: "International Maritime Organization"
    url: "https://www.imo.org/"
  - title: "Bureau of Labor Statistics — Marine Engineers"
    url: "https://www.bls.gov/ooh/architecture-and-engineering/marine-engineers-and-naval-architects.htm"
  - title: "Lloyd's Register — Marine Engineering"
    url: "https://www.lr.org/en/"
faq:
  - q: "What is the difference between marine engineering and naval architecture?"
    a: "Naval architecture focuses on hull design, stability, hydrodynamics, and structural integrity of a vessel — essentially, the ship itself as a floating structure. Marine engineering focuses on the systems inside the ship — propulsion, power generation, HVAC, piping, and auxiliary machinery. Think of it this way: the naval architect designs the bottle; the marine engineer designs everything inside it."
  - q: "How much do marine engineers earn?"
  ...
  - q: "Do marine engineers go to sea?"
...
Floating offshore wind — turbines on floating platforms anchored in deep water — is an emerging technology that combines marine engineering with [alternative energy](/alternative-energy) in ways that didn't exist a decade ago.
