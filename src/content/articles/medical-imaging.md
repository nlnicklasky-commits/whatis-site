...
description: "Medical imaging is the collection of techniques and processes used to create visual representations of the interior of the human body for clinical analysis."
...
externalSources:
  ...
  - title: "NIH - National Institute of Biomedical Imaging and Bioengineering"
    url: "https://www.nibib.nih.gov/"
  - title: "WHO - Diagnostic Imaging"
    url: "https://www.who.int/health-topics/diagnostic-imaging"
faq:
  - q: "Is medical imaging safe?"
    a: "Most forms of medical imaging are very safe. MRI and ultrasound use no ionizing radiation at all. X-rays and CT scans do involve radiation, but the doses used in modern equipment are carefully controlled and the diagnostic benefits almost always outweigh the small risks. Your doctor weighs these factors before ordering any scan."
  - q: "What is the difference between an MRI and a CT scan?"
    a: "CT scans use X-rays to create cross-sectional images and are excellent for viewing bones, detecting internal bleeding, and spotting tumors quickly. MRI uses strong magnetic fields and radio waves, producing highly detailed images of soft tissues like the brain, muscles, and ligaments. CT is faster (minutes vs. 30-60 minutes for MRI), but MRI provides better soft tissue contrast without radiation."
  - q: "How much does medical imaging cost?"
    a: "Costs vary widely. A basic X-ray might cost $100-$400, an ultrasound $200-$1,000, a CT scan $500-$3,000, and an MRI $1,000-$5,000 in the United States. Insurance coverage, geographic location, and whether you use an in-network facility all significantly affect your out-of-pocket expense."
  - q: "Can you get an MRI if you have metal implants?"
    a: "It depends on the implant. Many modern implants are labeled MRI-conditional, meaning they're safe under specific conditions. However, certain older implants, pacemakers, and metallic foreign bodies can be dangerous in the MRI's strong magnetic field. Always tell your doctor and MRI technologist about any implants or metal in your body before scheduling a scan."
---
