...
But medical-legal questions existed long before Zacchia. Ancient [Roman law](/roman-law) required physicians to examine wounds in assault cases. The Chinese text *Xi Yuan Ji Lu* ("The Washing Away of Wrongs"), written in 1247, is essentially a [forensic science](/forensic-science) manual — it describes how to distinguish drowning from strangulation and offers methods for detecting poisons.
...
Forensic medicine also encompasses forensic toxicology (identifying drugs and poisons in biological specimens), forensic [psychiatry](/psychiatry) (evaluating mental state for legal purposes), forensic odontology (dental identification of remains), and [forensic anthropology](/forensic-anthropology)) (analyzing skeletal remains).
...
2. **Breach** — The doctor's care fell below the accepted standard of practice
3. **Causation** — The substandard care directly caused the patient's injury
...
The National Research Council flagged this as a serious problem in a 2009 report, noting that the fragmented death investigation system leads to inconsistent practices, missed homicides, and unreliable death [statistics](/statistics). Reform has been slow.
...
Medical jurisprudence keeps evolving because medicine and society keep evolving. Genetic testing raises questions about privacy, discrimination, and the ownership of biological data. Telemedicine complicates jurisdictional issues — if a doctor in Texas treats a patient in California via video call, which state's laws apply? [Artificial intelligence](/artificial-intelligence) in diagnosis creates new questions about liability — if [an algorithm](/algorithms) misreads a scan, who's responsible?
