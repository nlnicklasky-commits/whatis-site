...
slug: mixology
description: "Mixology is the craft of creating mixed drinks — cocktails — by combining spirits, modifiers, sweeteners, citrus, bitters."
...
externalSources:
  ...
  - title: "Encyclopaedia Britannica: Cocktail"
    url: "https://www.britannica.com/topic/cocktail"
faq:
  - q: "What is the difference between a bartender and a mixologist?"
    a: "A bartender serves drinks — which may include cocktails but also beer, wine, and simple pours. A mixologist specializes in creating and crafting cocktails, often developing original recipes, studying flavor chemistry, and working with unusual ingredients. In practice, the terms overlap significantly, and many skilled bartenders dislike the term 'mixologist' as pretentious."
  - q: "What are the essential spirits for a home bar?"
    a: "Six bottles cover the vast majority of classic cocktails: vodka, gin, light rum, bourbon or rye whiskey, tequila, and a liqueur like triple sec or Cointreau. Add simple syrup, fresh citrus, and bitters, and you can make dozens of cocktails. Quality matters more than variety — a well-stocked bar with six good bottles beats a cluttered one with thirty mediocre ones."
  - q: "What is the craft cocktail movement?"
    a: "Starting around 2000-2005, bartenders in cities like New York, London, and San Francisco revived pre-Prohibition cocktail recipes, emphasized fresh ingredients over premixed syrups, and treated cocktail-making as a serious culinary discipline. The movement values seasonal ingredients, house-made syrups and bitters, proper ice, and presentation. It transformed cocktail culture from an afterthought to a genuine culinary art."
---
