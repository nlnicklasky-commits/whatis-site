...
faq:
  ...
  - q: "What does a molecular biologist do?"
    a: "Molecular biologists study biological processes at the molecular level. They work in research labs, biotech companies, pharmaceutical firms, forensics labs, and agricultural companies. Day-to-day work involves designing and running experiments using techniques like PCR, gel electrophoresis, gene cloning, protein analysis, and increasingly, genomic sequencing and bioinformatics."
---

# What Is Molecular Biology?

Molecular biology is the branch of [biology](/biology) that studies the structure and function of the macromolecules essential to life—primarily DNA, RNA, and proteins. It seeks to understand how genetic information is stored, transmitted, and expressed at the molecular level, and how these molecular processes underpin everything living organisms do.
...
2. **A phosphate group**
3. **A nitrogenous base** (adenine, thymine, guanine, or cytosine—abbreviated A, T, G, C)
...
Invented by Kary Mullis in 1983 (Nobel Prize, 1993), PCR amplifies a specific DNA sequence millions of times in a few hours. It requires only a tiny starting sample—theoretically, a single molecule of DNA. PCR is used in forensics, medical diagnostics, [genetics](/genetics) research, pathogen detection, and paternity testing. During the COVID-19 pandemic, RT-PCR (reverse transcription PCR) became the gold standard diagnostic test.
...
Molecular cloning involves inserting a gene of interest into a vector (a circular DNA molecule, typically a plasmid) and introducing it into bacteria, which replicate the vector along with their own DNA. This provides unlimited copies of the gene for study. The development of recombinant DNA technology in the 1970s by Paul Berg, Herbert Boyer, and Stanley Cohen launched the [biotechnology](/biotechnology) industry. The first commercial product was recombinant human insulin, produced by bacteria carrying the human insulin gene, approved in 1982.
...
DNA profiling, based on PCR amplification of variable genetic markers, can identify individuals with near-absolute certainty. [Forensic-science](/forensic-science) DNA analysis has exonerated hundreds of wrongly convicted individuals and identified perpetrators from trace biological evidence decades after crimes occurred.

## Molecular Biology and Evolution

Molecular biology has profoundly strengthened our understanding of [evolutionary-biology](/evolutionary-biology). By comparing DNA sequences across species, scientists can:
