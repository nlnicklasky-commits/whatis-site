...
description: "Naval architecture is the engineering discipline concerned with the design, construction, and operation of ships and other marine vessels."
category: technology
...
heroAlt: "A man wearing a white lab coat and safety goggles, intently examining a piece of machinery or equipment in a large"
...
wordCount: 2418
tier: "2"
relatedArticles: ["aerodynamics", "civil-engineering", "classical-mechanics", "automotive-engineering", "alternative-energy"]
externalSources:
  - title: "Society of Naval Architects and Marine Engineers (SNAME)"
    url: "https://www.sname.org/"
  - title: "Royal Institution of Naval Architects (RINA)"
    url: "https://www.rina.org.uk/"
  - title: "Encyclopaedia Britannica — Naval Architecture"
    url: "https://www.britannica.com/technology/naval-architecture"
  - title: "International Maritime Organization (IMO)"
    url: "https://www.imo.org/"
faq:
  - q: "What is the difference between naval architecture and marine engineering?"
    a: "Naval architecture focuses on the design of the vessel itself — hull form, stability, structural integrity, and seakeeping. Marine engineering focuses on the mechanical and electrical systems aboard the vessel — propulsion machinery, power generation, HVAC, plumbing, and auxiliary systems. In practice, the two disciplines overlap significantly and work closely together."
  - q: "Do naval architects only design military ships?"
    a: "No. Despite the word 'naval,' naval architects design all types of watercraft: commercial cargo ships, passenger ferries, oil tankers, cruise ships, fishing vessels, yachts, offshore platforms, submarines, and even floating structures like pontoon bridges. Military vessels are just one category among many."
  - q: "How long does it take to design and build a large ship?"
    a: "A major vessel like a container ship or cruise liner typically takes 2-3 years from initial design to delivery. The design phase alone can take 12-18 months. Construction at a shipyard takes another 12-24 months depending on vessel complexity and yard capacity. Specialized vessels like aircraft carriers can take 5-8 years."
  - q: "What degree do I need to become a naval architect?"
    a: "Most naval architects hold a bachelor's degree in naval architecture, marine engineering, or ocean engineering. Programs are offered at universities including MIT, University of Michigan, Webb Institute, Newcastle University, and Delft University of Technology. Some enter the field through mechanical or civil engineering degrees with marine specializations."
  - q: "Why don't ships tip over?"
...
**Decarbonization** is the industry's defining challenge for the coming decades. Finding viable zero-carbon fuels, designing efficient hull forms, and integrating [alternative energy](/alternative-energy) sources requires fundamental innovation.
