...
slug: neuroeconomics
description: "Neuroeconomics is an interdisciplinary field that combines neuroscience, economics, and psychology to understand how people make decisions."
category: science
...
heroAlt: "A man in a white lab coat is sitting at a desk, working on a laptop computer with a graph displayed on the screen"
...
wordCount: 2330
tier: "2"
relatedArticles: ["neuroscience", "cognitive-bias", "behavioral-psychology", "neurobiology", "cognitive-neuroscience"]
externalSources:
  - title: "Society for Neuroeconomics"
    url: "https://www.neuroeconomics.org/"
  - title: "Nobel Prize - Daniel Kahneman"
...
faq:
  - q: "Is neuroeconomics a real academic field?"
    a: "Yes. Neuroeconomics has dedicated academic journals, international conferences, graduate programs at major universities (including NYU, Caltech, and Zurich), and its own professional society. It emerged as a distinct discipline in the early 2000s and has grown substantially since."
  - q: "How does neuroeconomics differ from behavioral economics?"
    a: "Behavioral economics documents how people deviate from rational economic predictions using experiments and observation. Neuroeconomics goes further by examining the brain mechanisms that produce these deviations, using neuroimaging, lesion studies, and computational models to explain why people make the decisions they do."
  - q: "Can neuroeconomics predict individual decisions?"
    a: "Not precisely — human decision-making involves too many variables for exact prediction. But brain activity patterns can predict choices before people consciously report their decisions, sometimes by several seconds. Neuroeconomics can also identify which brain states make certain types of decisions more likely."
  - q: "Does neuroeconomics have practical applications?"
    a: "Yes. Applications include improving financial literacy programs, designing better public health interventions, understanding addiction as an economic decision-making disorder, improving negotiation strategies, and informing policy design through 'nudge' approaches that account for actual brain function rather than idealized rationality."
---
...
[Behavioral psychology](/behavioral-psychology) documented these irrationalities extensively. Daniel Kahneman and Amos Tversky's work on [cognitive bias](/cognitive-bias) demonstrated dozens of systematic ways humans deviate from rational choice. Kahneman won the Nobel Prize in Economics in 2002 — the first psychologist to do so — for showing that economic rationality is more fiction than fact.
...
This explains addiction at a neural level. Drugs of abuse hijack the immediate reward system with supernormal dopamine signaling. The [neurobiology](/neurobiology) of addiction is essentially a neuroeconomic problem: the brain's temporal discounting becomes so steep that immediate drug rewards overshadow catastrophic long-term consequences.
...
This connects to [cognitive neuroscience](/cognitive-neuroscience) research showing that trust involves the temporoparietal junction (theory of mind — modeling what the other person is thinking), the caudate nucleus (tracking whether trust was reciprocated), and the vmPFC (computing the value of cooperative versus competitive strategies).
