...
slug: neuroscience
description: "Neuroscience is the study of the nervous system, from brain cells and circuits to cognition, behavior, and consciousness. Here is how the field works."
category: science
...
heroAlt: "A woman in a white lab coat standing in a modern, well-lit office environment with computer monitors and other scientific"
...
wordCount: 2459
tier: "2"
relatedArticles: ["neuroanatomy", "neurobiology", "neurochemistry", "cognitive-neuroscience", "neuropharmacology"]
externalSources:
...
faq:
  - q: "What is the difference between neuroscience and neurology?"
    a: "Neuroscience is the scientific study of the nervous system — it's a research discipline. Neurology is a medical specialty focused on diagnosing and treating nervous system disorders. A neuroscientist studies how the brain works in a lab. A neurologist treats patients with Alzheimer's, epilepsy, or stroke. There's significant overlap, but the distinction is research versus clinical practice."
  - q: "How many branches of neuroscience are there?"
    a: "Neuroscience has at least a dozen major branches including neuroanatomy, neurobiology, neurochemistry, cognitive neuroscience, computational neuroscience, behavioral neuroscience, molecular neuroscience, developmental neuroscience, clinical neuroscience, social neuroscience, neuroeconomics, and neuropharmacology."
  - q: "Is neuroscience hard to study?"
    a: "Neuroscience draws from biology, chemistry, physics, psychology, mathematics, and computer science. This breadth makes it challenging but also means there are many entry points — you don't need to master all these fields, but you need comfort crossing disciplinary boundaries."
  - q: "What are the biggest unsolved questions in neuroscience?"
    a: "The major open questions include how consciousness arises from neural activity, how memories are stored and retrieved, what causes neurodegenerative diseases and how to prevent them, how the brain develops and wires itself, and how to repair damaged neural circuits. These represent some of the deepest unsolved problems in all of science."
---
...
Key discoveries include the ionic basis of the action potential (Hodgkin and Huxley, Nobel Prize 1963), the mechanism of synaptic transmission (Katz, Nobel Prize 1970), and the role of NMDA receptors in learning and memory. [Neurobiology](/neurobiology) and [neurochemistry](/neurochemistry) both operate at this level.
...
Where neuroscience meets psychology. [Cognitive neuroscience](/cognitive-neuroscience) studies the neural basis of cognition — attention, memory, language, decision-making, social behavior, and consciousness. It's the branch that asks: how does the brain produce the mind?
...
**Electroencephalography (EEG)** — scalp electrodes measure the summed electrical activity of millions of neurons. Cheap, portable, and excellent temporal resolution (millisecond timing), but poor spatial resolution. Used clinically for epilepsy diagnosis and extensively in [neurolinguistics](/neurolinguistics) and cognitive research.
...
**Diffusion Tensor Imaging (DTI)** — maps white matter connections by tracking water diffusion along axon bundles. This reveals the brain's "wiring diagram" — which regions are structurally connected, as [neuroanatomy](/neuroanatomy) researchers study in detail.
...
**AI and neuroscience** continue their bidirectional relationship. Neuroscience inspires [machine learning](/machine-learning) architectures, while AI tools accelerate neuroscience research — analyzing brain imaging data, predicting protein structures, and modeling neural circuits at scales impossible for human analysis.
