...
slug: oral-history
description: "Oral history is the systematic practice of recording, preserving, and interpreting firsthand accounts from people who experienced historical events."
category: history
tags: ["oral history", "historical research", "interviews", "social history"]
heroImage: "/images/articles/oral-history-hero.webp"
heroAlt: "Two elderly men engaged in a conversation, with one man holding a book and the other man gesturing with his hands"
...
wordCount: 1646
tier: "3"
relatedArticles: ["anthropology", "archaeology"]
externalSources:
  - title: "Oral History Association"
    url: "https://www.oralhistory.org/"
  - title: "Library of Congress: Oral History"
    url: "https://www.loc.gov/folklife/familyfolklife/oralhistory.html"
  - title: "Columbia University Center for Oral History Research"
    url: "https://www.college.columbia.edu/core/node/3768"
  - title: "Smithsonian Institution Oral History Program"
    url: "https://www.si.edu/oral-history"
faq:
  - q: "How is oral history different from a regular interview?"
    a: "Oral history interviews are structured to capture a person's full life experience or their perspective on specific historical events. They follow ethical guidelines, are recorded and archived for future researchers, and aim to create a permanent historical record. A regular interview might be for journalism or entertainment and doesn't follow the same preservation standards."
  - q: "Who can conduct oral history interviews?"
    a: "Anyone can conduct oral history interviews, from trained academics to community volunteers and students. The Oral History Association provides best practice guidelines covering informed consent, interview technique, and archival standards. Many public libraries and local historical societies run oral history projects with volunteer interviewers."
  - q: "Are oral histories reliable as historical sources?"
    a: "Oral histories are valuable but must be used carefully. People's memories can shift over time, and personal bias shapes how events are recalled. Historians treat oral accounts as one source among many, cross-referencing them with documents, photographs, and other testimony. The subjective nature of oral history is actually part of its value — it captures how people experienced and interpreted events."
  - q: "What equipment do you need for oral history?"
    a: "At minimum, you need a good-quality digital audio recorder and an external microphone. Many projects now use video recording as well. You'll also want a quiet interview space, a consent form, and a prepared list of open-ended questions. The Library of Congress recommends uncompressed audio formats like WAV for archival quality."
---
