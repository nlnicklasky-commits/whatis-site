...
slug: physics
description: "Physics is the science of matter, energy, and the fundamental forces governing the universe. Learn how physics explains everything from atoms to galaxies."
category: science
tags: ["science", "universe", "matter", "energy", "forces", "quantum mechanics", "relativity"]
heroImage: "/images/articles/physics-hero.webp"
heroAlt: "A person's hands holding a pen, writing on a piece of paper or a digital device, with a background of colorful lights and"
...
faq:
  ...
  - q: "Is physics all math?"
    a: "Physics relies heavily on mathematics as its language, but it is fundamentally about understanding nature through observation and experiment. Math provides the tools to express physical laws precisely and make predictions. You need math to do physics professionally, but physical intuition — understanding what equations mean about the real world — is equally important."
  - q: "What unsolved problems remain in physics?"
...
Physics is the science that studies matter, energy, space, time, and the fundamental forces that govern how everything in the universe behaves. From the quarks inside a proton to the expansion of the cosmos itself, physics tries to describe it all with a consistent set of laws expressed in the language of [mathematics](/mathematics).
...
[Classical mechanics](/classical-mechanics) is the study of motion and the forces that cause it. Newton's three laws, published in 1687, remain the foundation:

1. An object at rest stays at rest, and an object in motion stays in motion at constant velocity, unless acted upon by an external force.
...
[Electromagnetism](/electromagnetism) governs electric charges, magnetic fields, and light. Maxwell's equations, completed in 1865, showed that electricity and magnetism are two aspects of a single force, and that light is an electromagnetic wave traveling at 299,792,458 meters per second.
...
Electromagnetism underlies virtually all modern technology. Every electric motor, generator, radio, television, computer, phone, and light bulb operates through electromagnetic principles. The [electronics](/electronics) industry, worth trillions of dollars, is applied electromagnetism.
...
- **[Computational physics](/computational-physics)**: Numerical simulation of physical systems
- **[Geophysics](/geophysics)**: Physics of the Earth

## Connections to Everything

Physics is sometimes called the "foundation science" because its principles underlie all other natural sciences. [Chemistry](/chemistry) is ultimately the physics of electron behavior in atoms and molecules. [Biology](/biology) depends on chemistry, which depends on physics. [Earth science](/earth-science) applies physics to planetary processes. [Astronomy](/astronomy) is physics applied to celestial objects.

If classical mechanics interests you, [classical mechanics](/classical-mechanics) goes deeper into Newton, Lagrange, and Hamilton. For the electromagnetic side, [electromagnetism](/electromagnetism) covers Maxwell's equations and their applications. If cosmological questions grab you, [cosmology](/cosmology) and [astrophysics](/astrophysics) take the physics into space. And if you're fascinated by the mathematical tools physics uses, [mathematics](/mathematics) is the essential companion.
