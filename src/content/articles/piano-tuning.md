...
externalSources:
  ...
  - title: "Britannica - Musical Tuning and Temperament"
...
faq:
  - q: "How often should a piano be tuned?"
    a: "Most manufacturers recommend tuning twice a year — typically when seasonal humidity changes are greatest (spring and fall). New pianos may need tuning 3-4 times in the first year as strings stretch and settle. Concert pianos are tuned before every performance. A piano that hasn't been tuned in years may need multiple tuning sessions (pitch raises) to bring it back to standard pitch, as large adjustments don't hold well in a single pass."
