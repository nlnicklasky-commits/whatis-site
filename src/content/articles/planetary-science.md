---
title: "What Is Planetary Science?"
slug: planetary-science
description: "Planetary science studies planets, moons, and other bodies in our solar system and beyond. Learn how scientists explore worlds from Mars to distant exoplanets."
category: science
...
wordCount: 2415
tier: "2"
relatedArticles: ["astronomy", "astrophysics", "geology", "cosmology", "earth-science"]
externalSources:
  ...
  - title: "ESA - Solar System Exploration"
    url: "https://www.esa.int/Science_Exploration/Space_Science"
  - title: "USGS Astrogeology Science Center"
    url: "https://www.usgs.gov/centers/astrogeology-science-center"
faq:
  - q: "Is Pluto still a planet?"
    a: "No. In 2006, the International Astronomical Union reclassified Pluto as a dwarf planet because it hasn't cleared the neighborhood around its orbit. However, this remains controversial among some planetary scientists, and the debate reflects genuine questions about how to classify objects in the solar system."
  - q: "Could life exist on other planets in our solar system?"
    a: "Possibly. The most promising candidates are Mars (potential past or subsurface microbial life), Europa and Enceladus (subsurface oceans heated by tidal forces), and Titan (exotic chemistry in its methane seas). No life has been confirmed beyond Earth, but the conditions for it may exist in several places."
  - q: "How do scientists study planets we can't visit?"
    a: "Scientists use telescopes (ground-based and space-based), robotic spacecraft (orbiters, landers, rovers), spectroscopy (analyzing light to determine composition), radar mapping, and mathematical modeling. Each method reveals different information about a planet's atmosphere, surface, interior, and history."
  - q: "How many exoplanets have been discovered?"
    a: "As of early 2026, over 5,700 exoplanets have been confirmed, with thousands more candidates awaiting verification. The Kepler space telescope discovered the majority, and the James Webb Space Telescope is now characterizing their atmospheres. Current estimates suggest there are more planets than stars in our galaxy."
---
...
Planetary science draws from [geology](/geology) for understanding surfaces and interiors, [chemistry](/chemistry) for composition analysis, physics for orbital mechanics and atmospheric modeling, [astronomy](/astronomy) and [astrophysics](/astrophysics) for observational techniques, and [biology](/biology) for astrobiology. It feeds back into [earth science](/earth-science) by providing comparative data --- understanding Venus's greenhouse effect helps us understand Earth's climate system, and studying Mars's lost magnetic field helps us appreciate the importance of Earth's.

If the astronomical observation side interests you, [astronomy](/astronomy) goes deeper. For the geological processes on other worlds, [geology](/geology) provides the foundation. If the search for life drives your curiosity, astrobiology sits at the intersection of planetary science and [biology](/biology). And for the physics governing how planets form and interact, [astrophysics](/astrophysics) and [cosmology](/cosmology) expand the picture.
