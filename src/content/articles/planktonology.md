---
title: "What Is Planktonology?"
slug: planktonology
description: "Planktonology is the study of plankton, the tiny organisms that produce half our oxygen and underpin ocean food webs. Discover why plankton matter so much."
category: science
...
wordCount: 2160
tier: "2"
relatedArticles: ["marine-biology", "oceanography", "ecology", "biology", "climatology"]
externalSources:
  - title: "NOAA - What Are Plankton?"
    url: "https://oceanservice.noaa.gov/facts/plankton.html"
  - title: "NASA Earth Observatory - Phytoplankton"
    url: "https://earthobservatory.nasa.gov/features/Phytoplankton"
  - title: "Marine Biological Association - Plankton"
    url: "https://www.mba.ac.uk/plankton/"
  - title: "Tara Oceans Foundation"
    url: "https://fondationtaraocean.org/en/"
faq:
  - q: "What is the difference between phytoplankton and zooplankton?"
    a: "Phytoplankton are plant-like plankton that photosynthesize, producing oxygen and forming the base of ocean food webs. Zooplankton are animal plankton that feed on phytoplankton or other zooplankton. Together, they form the foundation of nearly all marine ecosystems."
  - q: "How much oxygen do plankton produce?"
    a: "Phytoplankton produce approximately 50% of Earth's oxygen through photosynthesis — roughly the same amount as all terrestrial plants combined. A single genus, Prochlorococcus, is estimated to produce about 20% of the oxygen in the entire biosphere."
  - q: "Can you see plankton with the naked eye?"
    a: "Most plankton are microscopic, but some are visible. Jellyfish are technically plankton (they drift with currents rather than swimming against them). Some colonial organisms like Pyrosoma can be meters long. But the majority of plankton — and the most ecologically important ones — are invisible without a microscope."
  - q: "Are plankton affected by climate change?"
    a: "Significantly. Rising ocean temperatures shift plankton distribution patterns, with warm-water species moving poleward. Ocean acidification affects shell-forming plankton. Changing nutrient availability alters phytoplankton productivity. Since plankton underpin marine food webs, these changes cascade through entire ecosystems."
---
