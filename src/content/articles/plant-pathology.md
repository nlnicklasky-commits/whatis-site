...
description: "Plant pathology studies diseases in plants caused by fungi, bacteria, viruses, and environmental stress — and how to prevent crop losses worldwide."
category: science
...
wordCount: 2787
tier: "2"
relatedArticles: ["botany", "agriculture", "microbiology", "ecology", "genetics"]
externalSources:
  - title: "American Phytopathological Society"
    url: "https://www.apsnet.org/"
  - title: "Plant Diseases — USDA Agricultural Research Service"
    url: "https://www.ars.usda.gov/research/plant-diseases/"
  - title: "FAO Plant Health"
    url: "https://www.fao.org/plant-health/en/"
  - title: "Phytopathology — Annual Reviews"
    url: "https://www.annualreviews.org/journal/phyto"
faq:
  - q: "What causes most plant diseases?"
    a: "Fungi are responsible for roughly 85% of plant diseases. Bacteria, viruses, nematodes, and oomycetes (water molds) cause most of the rest. Environmental stresses like nutrient deficiencies, pollution, and extreme temperatures can also cause disease-like symptoms without any pathogen involved."
  - q: "Can plant diseases affect humans?"
    a: "Plant pathogens themselves generally don't infect humans. However, some fungi that infect crops produce mycotoxins — toxic compounds that can cause serious illness if contaminated grain or food is consumed. Aflatoxins produced by Aspergillus fungi on peanuts and corn are a well-known example."
  - q: "How do plant pathologists diagnose plant diseases?"
    a: "Diagnosis combines visual symptom assessment, microscopic examination of tissues, culturing pathogens on growth media, serological tests (like ELISA), and molecular methods like PCR that detect pathogen DNA or RNA. Modern diagnostics increasingly use portable DNA sequencing devices for rapid field identification."
  - q: "What is the most destructive plant disease in history?"
    a: "The Irish Potato Famine (1845-1852), caused by the oomycete Phytophthora infestans (potato late blight), killed roughly one million people and caused another million to emigrate. Other historically devastating diseases include wheat stem rust, chestnut blight, and Panama disease of bananas."
---
...
The discovery that oomycetes aren't fungi had practical consequences. Some fungicides that work against true fungi are ineffective against oomycetes because the underlying [biochemistry](/biochemistry) is different.
...
This molecular arms race between pathogen effectors and plant resistance genes has been going on for millions of years. It's [evolutionary biology](/evolutionary-biology) at its most dramatic.
...
3. When the cultured organism is introduced to a healthy host, it must cause the same disease
4. The organism must be re-isolated from the newly diseased host and shown to be identical to the original
...
Portable diagnostic devices are increasingly important. Loop-mediated isothermal amplification (LAMP) assays can detect pathogens in the field without laboratory equipment. Smartphone-based imaging combined with [machine-learning](/machine-learning) can identify diseases from photographs with accuracy rivaling trained pathologists.
...
Fieldwork is a significant component — you'll spend time in crop fields, greenhouses, and forests examining sick plants. But increasingly, the work also involves bioinformatics, genomics, and computational modeling. The [data-science](/data-science) revolution has reached plant pathology in a big way.
...
**RNA interference (RNAi)** technology offers a new approach to disease control. Spraying plants with small RNA molecules that silence essential pathogen genes — so-called "spray-induced gene silencing" — could provide targeted, biodegradable disease control without the environmental persistence of traditional [chemistry](/chemistry) fungicides.

**Predictive modeling** using weather data, pathogen biology, and [machine-learning](/machine-learning) enables disease forecasting — telling farmers when conditions favor disease and when to apply management measures. This reduces unnecessary chemical applications while ensuring timely protection.
