...
wordCount: 2812
tier: "2"
relatedArticles: ["ecology", "botany", "agriculture", "evolutionary-biology", "entomology"]
externalSources:
  - title: "USDA Forest Service — Celebrating Wildflowers: Pollination"
    url: "https://www.fs.usda.gov/wildflowers/pollinators/"
  - title: "Pollinator Partnership"
    url: "https://www.pollinator.org/"
  - title: "FAO — Pollinators"
    url: "https://www.fao.org/biodiversity/components/pollinators/en/"
  - title: "USGS — Why Are Pollinators Important?"
    url: "https://www.usgs.gov/faqs/why-are-pollinators-important"
faq:
  - q: "What percentage of food crops depend on pollinators?"
    a: "Approximately 75% of the world's flowering food crop species depend at least partially on animal pollinators. About 35% of global crop production volume benefits from animal pollination. Key pollinator-dependent crops include almonds, apples, blueberries, chocolate (cacao), coffee, melons, and squash."
  - q: "Can plants pollinate themselves?"
    a: "Yes, many plants can self-pollinate — transferring pollen from the anther to the stigma within the same flower or between flowers on the same plant. Wheat, rice, soybeans, and tomatoes are largely self-pollinating. However, cross-pollination (receiving pollen from a different individual) generally produces healthier, more genetically diverse offspring."
  - q: "Why are bee populations declining?"
    a: "Multiple interacting factors drive bee declines: pesticide exposure (especially neonicotinoids), habitat loss, parasites and diseases (particularly the Varroa destructor mite in honeybees), poor nutrition from reduced wildflower diversity, and climate change altering the timing of flower availability relative to bee emergence."
  - q: "What is the economic value of pollination?"
    a: "Animal pollination contributes an estimated $235-577 billion (USD) annually to global agriculture, according to IPBES (Intergovernmental Science-Policy Platform on Biodiversity and Ecosystem Services). In the United States alone, honeybee pollination services are valued at approximately $15 billion per year."
---
...
Let's start with the mechanics, because they're more interesting than your high school [biology](/biology) class probably made them seem.
...
**Cross-pollination** transfers pollen between different individual plants of the same species. This shuffles [genetics](/genetics) like dealing from a fresh deck, producing offspring with new trait combinations. More genetic diversity means more raw material for [evolutionary biology](/evolutionary-biology) to work with.
...
This is where things get genuinely wild. Plants can't move, so they've recruited an astonishing diversity of animals to transport their pollen. The relationships between plants and pollinators are among the most fascinating in [ecology](/ecology).
...
The intersection of pollination and [agriculture](/agriculture) has enormous economic stakes.
...
In parts of China's Sichuan province, hand pollination of apple and pear orchards has become necessary because local pollinator populations have been wiped out by pesticide use. Workers climb trees with tiny brushes made from chicken feathers and cigarette filters, dabbing pollen onto individual flowers. It works, but it's expensive, slow, and a stark warning of what [agriculture](/agriculture) without pollinators looks like.

## The Evolutionary Story

The co-evolution of flowering plants and pollinators is one of the great stories in [evolutionary biology](/evolutionary-biology).
