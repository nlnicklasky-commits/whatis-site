...
slug: pragmatism
description: "Pragmatism judges ideas by their real-world results, not abstract truth. Learn how this American philosophy shaped science, education, and modern thinking."
category: philosophy
...
heroAlt: "A smiling woman with curly hair is sitting at a desk, working on a laptop computer"
...
wordCount: 3407
tier: "1"
relatedArticles: ["ethics", "humanism", "stoicism", "psychology", "liberalism"]
externalSources:
  - title: "Pragmatism - Stanford Encyclopedia of Philosophy"
    url: "https://plato.stanford.edu/entries/pragmatism/"
  - title: "William James - Internet Encyclopedia of Philosophy"
    url: "https://iep.utm.edu/james-o/"
  - title: "John Dewey - Stanford Encyclopedia of Philosophy"
    url: "https://plato.stanford.edu/entries/dewey/"
  - title: "Charles Sanders Peirce - Stanford Encyclopedia of Philosophy"
    url: "https://plato.stanford.edu/entries/peirce/"
faq:
  - q: "What is pragmatism in simple terms?"
    a: "Pragmatism is a philosophy that judges ideas by their practical consequences. Instead of asking 'Is this theory abstractly true?' pragmatists ask 'Does believing this make a real difference in how we live?' If an idea works and produces useful results, that's what matters."
  - q: "Who founded pragmatism?"
    a: "Charles Sanders Peirce is generally credited as the founder of pragmatism in the 1870s, but William James popularized it in the early 1900s and John Dewey extended it into education and social reform. All three are considered the classical pragmatists."
...
The pragmatist asks: What practical difference does it make? If believing in free will leads people to take responsibility, make better choices, and build [ethical](/ethics) systems that improve society — and if believing in strict determinism leads to fatalism and resignation — then the belief in free will is the more useful one. That's what matters.
...
The connection between pragmatism and modern technology culture runs deeper than most people realize. The iterative approach used in [agile software development](/agile-software-development) — build something, test it, learn from the results, iterate — is fundamentally pragmatist. You don't design the perfect system on paper and then build it. You build, test, and improve.
