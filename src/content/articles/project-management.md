...
description: "Project management is how teams plan, execute, and deliver work on time and on budget. Learn the methods, tools, and skills that make projects succeed."
category: technology
...
wordCount: 2720
tier: "2"
relatedArticles: ["agile-software-development", "business-strategy", "lean-manufacturing", "logistics", "operations-research"]
externalSources:
  ...
  - title: "Harvard Business Review - Project Management"
    url: "https://hbr.org/topic/project-management"
faq:
  - q: "What is project management in simple terms?"
    a: "Project management is the practice of planning, organizing, and overseeing work to achieve a specific goal within defined constraints of time, budget, and scope. It's how teams turn ideas into finished deliverables without chaos taking over."
  - q: "What is the PMP certification?"
    a: "The Project Management Professional (PMP) is a globally recognized certification from the Project Management Institute (PMI). It requires 3-5 years of project management experience, 35 hours of education, and passing a 180-question exam. It's the most widely respected PM credential."
  - q: "What is the difference between Agile and Waterfall?"
    a: "Waterfall completes each phase sequentially before moving to the next—requirements, design, build, test, deploy. Agile works in short iterative cycles (sprints), delivering small increments and adjusting based on feedback. Waterfall suits projects with fixed requirements; Agile suits projects where requirements evolve."
  - q: "Do I need a certification to be a project manager?"
    a: "Not necessarily. Many successful project managers learned through experience. However, certifications like PMP, PRINCE2, or Certified ScrumMaster demonstrate knowledge and can improve job prospects, especially in larger organizations that value formal credentials."
  - q: "What tools do project managers use?"
...
[Agile](/agile-software-development) emerged as a response to Waterfall's rigidity. The 2001 Agile Manifesto, written by 17 software developers, prioritized:
