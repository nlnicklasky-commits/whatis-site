...
slug: prop-making
description: "Prop making is the craft of creating physical objects used by performers in theater, film, television, and related productions."
...
heroAlt: "A man working on a woodworking project in a workshop"
...
externalSources:
  ...
  - title: "Britannica — Theatrical Property"
    url: "https://www.britannica.com/art/theatrical-property"
  - title: "Smithsonian — Movie Props"
    url: "https://www.si.edu/spotlight/entertainment"
faq:
  - q: "What is the difference between a prop and a set piece?"
    a: "A prop (short for 'property') is any object an actor picks up, interacts with, or carries during a performance — a sword, a cup, a letter, a phone. A set piece is part of the scenery — a wall, a staircase, furniture that actors don't move. The distinction can blur (a chair someone sits in might be a set piece; a chair someone throws is a prop), and prop departments often handle both."
  - q: "What materials do prop makers use?"
    a: "Almost everything. Common materials include foam (EVA foam, upholstery foam, expanding foam), thermoplastics (Worbla, Sintra), fiberglass, resin casting materials, wood, metal, fabric, 3D-printed plastics, paper mache, and silicone. The choice depends on the prop's appearance requirements, weight constraints, safety needs (stage weapons must be safe), budget, and whether it needs to survive one performance or an entire film shoot."
  - q: "How do you become a prop maker?"
    a: "There's no single path. Some prop makers study theater design or film production in college. Others come from fine art, sculpture, industrial design, or engineering backgrounds. Many are self-taught through community theater, cosplay, or personal projects. Building a portfolio of work is more important than formal credentials. Entry-level positions in theater or film prop shops provide hands-on training."
---
...
**Mold making and casting** — creating silicone or plaster molds of an original [sculpture](/sculpture), then pouring resin, fiberglass, or foam to produce copies. This is essential when you need multiple identical props or when the final material needs to be different from the sculpting material.
...
The **lightsaber** from *Star Wars* (1977) — the original was built from a 1930s Graflex camera flash handle. It became the most recognizable prop in [film history](/film-history).
...
**Wilson the [volleyball](/volleyball)** from *Cast Away* (2000) — a regulation Wilson volleyball with a bloody handprint face. It became so iconic that Wilson Sporting Goods now sells replica versions.

## A Growing Field

The prop-making field is expanding beyond traditional entertainment. Theme parks employ large prop-making departments. Escape rooms need custom props. Museums commission replicas. Corporate events, product launches, and experiential [marketing](/marketing) all use custom-built props.
