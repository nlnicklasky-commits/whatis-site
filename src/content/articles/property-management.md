...
description: "Property management is the operation, oversight, and administration of real estate on behalf of the property owner."
category: finance
...
wordCount: 2246
tier: "2"
relatedArticles: ["finance", "insurance", "business-law", "budgeting", "entrepreneurship"]
externalSources:
  - title: "IREM - Institute of Real Estate Management"
  ...
  - title: "NARPM - Property Management Association"
    url: "https://www.narpm.org/"
faq:
  - q: "How much do property managers charge?"
    a: "Residential property managers typically charge 8-12% of monthly rent collected, plus a leasing fee of 50-100% of one month's rent for placing new tenants. Commercial property managers charge 4-8% of gross rent. Some charge flat monthly fees instead, typically $100-300 per unit."
  - q: "What is the difference between a property manager and a landlord?"
    a: "A landlord owns the property. A property manager is hired by the landlord to handle day-to-day operations—tenant screening, rent collection, maintenance, and legal compliance. Many landlords manage their own properties, but those with multiple properties or limited time often hire professional managers."
  - q: "Do property managers need a license?"
    a: "Requirements vary by state and country. Most US states require property managers to hold a real estate broker's license or work under a licensed broker. Some states have specific property management licenses. A few states have no licensing requirements. Always check your local regulations."
  - q: "When should a landlord hire a property manager?"
    a: "Consider hiring when you own multiple properties, live far from your rental, don't want to handle tenant calls and maintenance requests, need help with legal compliance, or when the time you spend managing exceeds the cost of hiring a professional."
...
Beyond rent, property managers handle [budgeting](/budgeting) and financial reporting for owners. Monthly financial statements typically include income received, expenses paid, maintenance costs, vacancy losses, and owner distributions. Annual reporting includes 1099 tax forms and property-level profit/loss statements.
...
- **[Insurance](/insurance) requirements**: Both parties carry specific insurance — the manager carries errors and omissions (E&O) insurance; the owner carries property and liability insurance.
