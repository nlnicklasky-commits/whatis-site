...
slug: pruning
description: "Pruning is the deliberate removal of specific parts of a plant — branches, buds, roots, or dead material — to improve the plant's health, structure."
...
wordCount: 914
tier: "3"
relatedArticles: ["gardening", "horticulture", "agriculture", "botany", "landscaping"]
externalSources:
  - title: "USDA Forest Service — Pruning Trees"
    url: "https://www.fs.usda.gov/"
  - title: "University of Minnesota Extension — Pruning"
    url: "https://extension.umn.edu/planting-and-growing-guides/pruning-trees-and-shrubs"
  - title: "Royal Horticultural Society — Pruning"
    url: "https://www.rhs.org.uk/pruning"
faq:
  ...
  - q: "How much of a tree can you safely prune at once?"
    a: "The general rule is never remove more than 25% of a tree's canopy in a single year. Removing more stresses the tree, reduces its ability to produce energy through photosynthesis, and can trigger excessive water sprout growth. For mature trees, 10-15% per year is often safer. Young trees being trained to a specific shape can tolerate slightly more aggressive pruning."
  - q: "Should you seal pruning cuts with paint or wound dressing?"
    a: "No. Research has consistently shown that tree wound sealants and pruning paints do not prevent decay and may actually slow the tree's natural healing process. Trees naturally compartmentalize wounds — sealing off damaged tissue with chemical and physical barriers. Wound dressings can trap moisture and create conditions favorable for decay organisms. The best practice is to make clean cuts at the proper location and let the tree heal itself."
---
...
1. Make an undercut 12-18 inches from the trunk, cutting about one-third through the branch from below
2. Make a top cut slightly farther from the trunk than the undercut — the branch will snap cleanly between the two cuts
3. Remove the remaining stub with a clean cut at the branch collar
