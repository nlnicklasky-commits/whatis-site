...
slug: psychophysics
description: "Psychophysics studies the relationship between physical stimuli and the sensations they produce, measuring how we perceive light, sound, touch, and taste."
category: science
...
heroAlt: "A woman in a white lab coat is sitting at a desk, working on a computer with multiple monitors displaying graphs and charts"
...
wordCount: 2457
tier: "2"
relatedArticles: ["psychology", "cognitive-psychology", "neuroscience", "acoustics", "mathematics"]
externalSources:
  - title: "Stanford Encyclopedia of Philosophy - Measurement in Psychology"
    url: "https://plato.stanford.edu/entries/measurement-science/"
  - title: "Fechner's Elements of Psychophysics (Historical)"
    url: "https://psychclassics.yorku.ca/Fechner/"
  - title: "Journal of Vision"
    url: "https://jov.arvojournals.org/"
  - title: "Acoustical Society of America"
    url: "https://acousticalsociety.org/"
faq:
  - q: "What is the difference between psychophysics and neuroscience?"
    a: "Neuroscience studies the biological mechanisms of the brain and nervous system. Psychophysics studies the relationship between physical stimuli and conscious perception without necessarily examining the underlying neural mechanisms. Think of it this way: psychophysics measures what you perceive, while neuroscience explains how your brain creates that perception."
  - q: "What is an absolute threshold?"
    a: "An absolute threshold is the minimum intensity of a stimulus that a person can detect 50% of the time. For example, the absolute threshold for vision is roughly equivalent to seeing a candle flame 30 miles away on a dark, clear night. These thresholds vary between individuals and change with factors like fatigue, attention, and adaptation."
  - q: "Is psychophysics still relevant today?"
    a: "Very much so. Psychophysics methods are used in designing smartphone displays, calibrating audio equipment, developing medical diagnostic imaging, testing hearing aids, creating virtual reality systems, and optimizing user interfaces. Any technology that presents sensory information to humans benefits from psychophysical research."
  - q: "Who founded psychophysics?"
    a: "Gustav Theodor Fechner, a German physicist and philosopher, is considered the founder. His 1860 book 'Elements of Psychophysics' established the field by proposing mathematical relationships between physical stimuli and psychological sensations. Ernst Heinrich Weber's earlier work on the just-noticeable difference laid important groundwork."
---
...
SDT has spread far beyond psychophysics into [data analysis](/data-analysis), medical diagnostics, quality control, and [machine learning](/machine-learning) (where the ROC curve—Receiver Operating Characteristic—directly descends from SDT). The concept of separating sensitivity from bias turns out to be useful whenever someone must make decisions under uncertainty.
...
Modern psychophysics often pairs perceptual measurements with neural recordings, creating the field of "neural psychophysics" or relating to [neuroscience](/neuroscience) more broadly.
