...
description: "Public administration is the implementation of government policy through organized management of public programs and services."
category: politics
tags: ["public administration", "government", "public policy", "bureaucracy", "public service", "management"]
heroImage: "/images/articles/public-administration.webp"
...
- **State governments** — departments of [education](/education), transportation, health, and corrections
...
What ties these together is the challenge of managing organizations that serve the public interest rather than private profit. The constraints are different from private sector [management](/management). You can't choose your customers. You can't keep your operations private. You're accountable to elected officials, the public, the media, and the courts simultaneously.

## The Core Functions

**[Budgeting](/budgeting) and [finance](/finance).** Government budgets are the most tangible expression of public priorities. Public administrators develop, justify, manage, and account for budgets that can range from a small-town library's $200,000 to the federal government's $6+ trillion. Every dollar is public money, which means every dollar is subject to oversight, audit, and political scrutiny.
...
**Regulation.** Government agencies create and enforce detailed rules that translate broad laws into specific requirements. The Clean Air Act is a few hundred pages; the regulations implementing it fill thousands. Regulatory administration balances competing interests — industry, environmental groups, [public health](/public-health), economic growth — within the framework the law provides.
...
The academic study of public administration is often traced to Woodrow Wilson's 1887 essay "The Study of Administration," which argued that [running](/running) a government is different from deciding what government should do. Wilson wanted administration separated from [politics](/politics) — a professional, expert-driven function distinct from partisan maneuvering.
...
**Measurement difficulty.** How do you measure the "[productivity](/productivity)" of a public school, a national park, or a fire department? Unlike businesses (where profit provides a clear metric), public organizations pursue goals that are complex, contested, and hard to quantify.
