...
slug: publishing
description: "Publishing is the process of making content — books, magazines, newspapers, journals, digital media — available to the public."
...
faq:
  ...
  - q: "Is self-publishing legitimate?"
    a: "Yes, and the stigma has largely disappeared. Self-published authors control their rights, pricing, and creative decisions, and keep a larger percentage of revenue (typically 35-70% vs. 10-15% from traditional publishers). Amazon's Kindle Direct Publishing alone generates billions in revenue for independent authors. Some self-published books have become major bestsellers. The trade-off is that the author handles everything the publisher would normally do."
  - q: "How many books are published each year?"
    a: "Estimates vary, but roughly 2.2-4 million new books are published annually worldwide, including self-published titles. In the U.S., about 500,000 traditional titles and over 2 million self-published titles appear each year. The number has exploded since the rise of digital self-publishing platforms in the 2010s. The vast majority of these books sell fewer than 250 copies."
---
