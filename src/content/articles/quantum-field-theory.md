...
description: "Quantum field theory describes the universe as fields, not particles. It's the foundation of modern physics and the Standard Model. Here's how it works."
category: science
...
heroAlt: "The woman is sitting at a desk in a laboratory setting, surrounded by scientific equipment and materials"
...
wordCount: 2752
tier: "2"
relatedArticles: ["electromagnetism", "mathematical-physics", "quantum-chemistry", "experimental-physics", "mathematics"]
externalSources:
  - title: "CERN - The Standard Model"
    url: "https://home.cern/science/physics/standard-model"
  - title: "Stanford Encyclopedia of Philosophy - Quantum Field Theory"
    url: "https://plato.stanford.edu/entries/quantum-field-theory/"
  - title: "Perimeter Institute - Quantum Field Theory"
    url: "https://perimeterinstitute.ca/research/research-areas/quantum-fields-and-strings"
  - title: "Particle Data Group"
    url: "https://pdg.lbl.gov/"
faq:
  - q: "What's the difference between quantum mechanics and quantum field theory?"
...
This is the same principle behind Feynman diagrams in [quantum electrodynamics](/quantum-electrodynamics). Each diagram represents a class of paths through field configuration space, and summing diagrams gives increasingly precise predictions.
...
This deep connection between symmetry and conservation laws is one of the most beautiful results in all of [mathematics](/mathematics) and physics.
...
Renormalization, developed for [QED](/quantum-electrodynamics) in the 1940s, absorbs the infinities into redefinitions of physical parameters (mass, charge). Only a finite number of parameters need renormalization, and once they're fixed by measurement, all other predictions are finite and precise.
...
The Standard Model QFT accounts for about 5% of the universe's energy content. The remaining 95% -- dark matter (~27%) and dark energy (~68%) -- isn't described by any field in the Standard Model. We know dark matter and dark energy exist from [astrophysical](/astrophysics) observations, but their quantum field descriptions remain unknown.
