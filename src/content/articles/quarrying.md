...
heroAlt: "A yellow excavator digging into the ground in a rocky area, with a cloudy blue sky in the background"
...
faq:
  ...
  - q: "What materials come from quarries?"
    a: "Quarries produce crushed stone (limestone, granite, sandstone, basalt), sand, gravel, clay, slate, marble, dimension stone for buildings, aggregate for concrete and asphalt, limestone for cement, and industrial minerals. In the US alone, quarries produce about 1.5 billion metric tons of crushed stone and 1 billion metric tons of sand and gravel annually."
---
...
Before any rock is extracted, extensive [geological](/geology) surveys determine the quality, quantity, and structure of the deposit. Core drilling extracts cylindrical samples from various depths. Geophysical surveys map subsurface structures. Chemical analysis confirms the rock meets specifications.
...
1. Fragment the rock to the desired size (smaller is better for processing)
2. Move the broken rock to a pile where it can be loaded
3. Minimize vibration and airblast reaching neighboring properties
4. Maintain stable quarry walls
