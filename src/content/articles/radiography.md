---
title: "What Is Radiography?"
slug: radiography
description: "Radiography uses X-rays and other radiation to create images of the body's interior. Learn how it works, its medical uses, safety, and modern advances."
category: technology
...
heroAlt: "A radiographer, a medical professional, wearing a mask and glasses, standing in a medical setting with a patient visible"
...
X-rays are a form of [electromagnetic](/electromagnetism) radiation, just like visible light, but with much shorter wavelengths (0.01 to 10 nanometers) and correspondingly higher energy. They're generated in an X-ray tube:

1. A cathode (a heated filament, similar to a light bulb) releases electrons through thermionic emission.
2. A high voltage (typically 40-150 kilovolts) accelerates these electrons toward an anode (target), usually made of tungsten.
3. The electrons slam into the tungsten at roughly half the speed of light.
4. The sudden deceleration of the electrons produces X-ray photons (bremsstrahlung radiation).
5. Additional X-rays are produced when the electrons knock inner-shell electrons out of tungsten atoms and outer electrons drop down to fill the vacancies (characteristic radiation).
