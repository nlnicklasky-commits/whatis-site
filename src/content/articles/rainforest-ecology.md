...
heroAlt: "Rainforest ecology is the scientific study of how organisms in tropical and subtropical forests interact with each other"
...
wordCount: 3319
tier: "1"
relatedArticles: ["ecology", "conservation-biology", "environmental-science", "biology", "climatology"]
externalSources:
  - title: "Rainforests - National Geographic"
    url: "https://education.nationalgeographic.org/resource/rain-forest/"
  - title: "Tropical Rainforest - WWF"
    url: "https://www.worldwildlife.org/biomes/tropical-and-subtropical-moist-broadleaf-forests"
  - title: "USGS Tropical Ecosystems"
    url: "https://www.usgs.gov/programs/climate-research-and-development-program/science/tropical-ecosystems"
  - title: "Rainforest Alliance"
    url: "https://www.rainforest-alliance.org/everyday-actions/what-is-a-tropical-rainforest/"
faq:
  - q: "What percentage of Earth's species live in rainforests?"
    a: "Rainforests contain roughly 50% of all plant and animal species on Earth despite covering only about 6% of the planet's land surface. This extraordinary concentration of biodiversity makes them the most species-rich biome anywhere."
  - q: "Why are rainforests called the lungs of the Earth?"
    a: "Rainforests produce approximately 28% of the world's oxygen through photosynthesis and absorb massive amounts of carbon dioxide. However, they also consume much of that oxygen through respiration, so their bigger climate role is actually as carbon sinks storing an estimated 250 billion tons of carbon."
  - q: "How fast are rainforests disappearing?"
    a: "Between 2001 and 2023, the tropics lost roughly 6.5 million hectares of primary forest per year on average. That is about 10 football fields per minute. Deforestation rates have slowed in some countries like Brazil but accelerated in others across Southeast Asia and Central Africa."
  - q: "Can destroyed rainforests grow back?"
    a: "Secondary rainforests can regrow on cleared land, but full recovery takes 100 to 200 years or more. Even then, a regrown forest rarely matches the original biodiversity. Many specialist species that require old-growth conditions never return once lost from an area."
  - q: "What is the biggest threat to rainforests today?"
    a: "Agricultural expansion is the leading driver of rainforest destruction, responsible for about 80% of tropical deforestation worldwide. Cattle ranching, soy farming, palm oil plantations, and logging are the primary activities converting forest to other land uses."
---
...
This layer is critical for [animal behavior](/animal-behavior) studies because it's where many birds, snakes, and insects carry out their daily activities, sheltered from the canopy's exposure to weather.
...
[Conservation biology](/conservation-biology) cares about these numbers because species we haven't even cataloged yet are going extinct. Scientists estimate that only about 15% of rainforest species have been formally described. We're losing species before we know they exist.

### Why So Many Species?

This is actually one of the biggest open questions in [ecology](/ecology). Several hypotheses compete:
...
The primary drivers are well-documented by [environmental science](/environmental-science) researchers:
...
Not all conservation strategies are equally effective. Research in [conservation biology](/conservation-biology) has identified several approaches with proven track records.
