...
heroAlt: "A smiling man in a suit holding a brochure or document with a house image on it, standing in front of a window"
...
wordCount: 3128
tier: "1"
relatedArticles: ["real-estate", "finance", "investment-management", "financial-planning", "financial-modeling"]
externalSources:
  - title: "National Association of Realtors - Investment Research"
    url: "https://www.nar.realtor/research-and-statistics"
  - title: "SEC - Real Estate Investment Trusts (REITs)"
    url: "https://www.sec.gov/answers/reits.htm"
...
Real estate offers tax benefits that virtually no other [investment management](/investment-management) category can match.
...
The historical returns are solid. From 1972 to 2023, the FTSE Nareit All Equity REIT Index returned roughly 11.5% annually — comparable to the S&P 500. But with significantly less correlation, meaning REITs can zig when stocks zag, providing [financial planning](/financial-planning) diversification benefits.
...
The mitigation: thorough screening (credit check, income verification, rental history, criminal background), requiring deposits, maintaining the property well (good tenants expect good properties), and understanding local landlord-tenant [contract law](/contract-law).
...
**Ignoring location fundamentals**: A cheap property in a declining market with no job growth and shrinking population is cheap for a reason. Population growth, job diversity, and [economics](/economics) fundamentals matter more than purchase price.
...
Industrial and data center properties remain strong, driven by e-commerce growth and the expanding needs of [artificial intelligence](/artificial-intelligence) infrastructure. Multi-family housing remains in demand as homeownership affordability challenges push more people into renting.
