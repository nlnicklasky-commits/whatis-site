...
description: "Scientific writing communicates research findings with precision and clarity. Learn its structure, conventions, style rules, and how to write effective papers."
category: science
...
heroAlt: "A group of scientists in a laboratory setting, engaged in discussion and collaboration"
...
wordCount: 2997
tier: "2"
relatedArticles: ["scientific-method", "data-analysis", "algorithms", "cognitive-bias", "biology"]
externalSources:
  - title: "Nature - How to Write a First-Class Paper"
...
1. **Establishes context**: What's the general topic? Why is it important? What do we already know?
2. **Identifies the gap**: What don't we know? What question remains unanswered? What problem hasn't been solved?
3. **States the purpose**: What does this paper do to fill that gap?
...
For computational work, including [algorithms](/algorithms) used in data processing, provide enough detail (or references to published methods) for replication. Ideally, share your code in a public repository.
...
1. **Summarize key findings** (briefly—don't repeat the Results section)
2. **Interpret and compare**: What do your results mean? How do they relate to previous studies? Do they support or contradict existing theories?
3. **Address limitations**: What are the weaknesses of your study? What can't your results tell us? Being honest about limitations increases credibility—reviewers will identify them anyway
4. **Broader implications**: What does this mean for the field? What should future research investigate?

Common mistakes: overstating your results ("this definitively proves"), ignoring contradictory evidence, failing to acknowledge limitations, and speculating far beyond what your data support. The Discussion is where [cognitive bias](/cognitive-bias) most easily infiltrates scientific writing—the temptation to present your results in the best possible light is real and must be actively resisted.
...
Bad: "The determination of protein concentration was carried out utilizing the Bradford assay methodology."
Better: "We measured protein concentration using the Bradford assay."
