...
slug: soil-mechanics
description: "Soil mechanics studies how soil behaves under stress and water flow. Learn about soil properties, testing methods, and applications in construction."
category: science
...
wordCount: 2366
tier: "2"
relatedArticles: ["civil-engineering", "geology", "earth-science", "concrete-technology", "engineering"]
externalSources:
  - title: "USGS: Soil and Water Science"
    url: "https://www.usgs.gov/programs/water-resources/science/soil-water"
  - title: "FHWA Geotechnical Engineering"
    url: "https://www.fhwa.dot.gov/engineering/geotech/"
  - title: "MIT OpenCourseWare: Soil Mechanics"
    url: "https://ocw.mit.edu/courses/1-361-advanced-soil-mechanics-fall-2004/"
  - title: "ASCE: Geotechnical Engineering"
    url: "https://www.asce.org/communities/institutes-and-technical-groups/geo-institute"
faq:
  - q: "What is the difference between soil mechanics and soil science?"
    a: "Soil mechanics focuses on the physical and mechanical behavior of soil — how it deforms under load, how water flows through it, and how stable it is for construction. Soil science is broader, also covering soil chemistry, biology, classification, and fertility for agricultural purposes. A soil mechanics engineer wants to know if soil can support a building; a soil scientist might want to know if it can grow wheat."
  - q: "Why do buildings sink or tilt?"
    a: "Buildings sink (settle) when the weight of the structure compresses the soil beneath it. Uneven settlement — one side sinking more than the other — causes tilting. This happens when soil conditions vary across the foundation footprint, when groundwater levels change, or when the soil wasn't properly characterized before construction. The Leaning Tower of Pisa tilts because it was built on soft clay that compresses unevenly."
...
The 1928 failure of the St. Francis Dam in California (which killed over 400 people) and the 1976 failure of the Teton Dam in Idaho were both geotechnical failures. Dam safety remains one of the highest-stakes applications of [soil science](/soil-science) and soil mechanics.
