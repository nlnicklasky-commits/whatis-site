...
description: "Subatomic particles are any particles smaller than an atom — the quarks, leptons."
category: science
...
externalSources:
  ...
  - title: "DOE Office of Science — Particle Physics"
    url: "https://www.energy.gov/science/doe-explainsparticle-physics"
  - title: "Stanford Linear Accelerator Center (SLAC)"
    url: "https://www6.slac.stanford.edu/"
  - title: "Fermilab — Science at Fermilab"
    url: "https://www.fnal.gov/pub/science/"
faq:
  - q: "How many subatomic particles are there?"
    a: "The Standard Model identifies 17 fundamental particles: 6 quarks, 6 leptons, 4 force-carrying bosons, and the Higgs boson. But composite particles like protons and neutrons (made of quarks) bring the total much higher."
  - q: "Can you actually see a subatomic particle?"
    a: "No. Subatomic particles are far too small to see with any microscope. Scientists detect them indirectly by observing their tracks, energy signatures, and decay products in particle detectors."
  - q: "What is the smallest subatomic particle?"
    a: "Quarks and electrons are considered fundamental—they have no known substructure. Electrons are effectively point particles with no measurable size, making them among the smallest known objects."
  - q: "Why does understanding subatomic particles matter?"
    a: "Subatomic particle research has led to MRI machines, cancer radiation therapy, the World Wide Web (invented at CERN), nuclear energy, and semiconductor technology that powers every phone and computer."
  - q: "What is the Higgs boson and why was it so important?"
...
Murray Gell-Mann and George Zweig independently proposed in 1964 that many of these particles were actually made of even smaller things — [quarks](/chemistry). The name came from a line in James Joyce's *Finnegans Wake*: "Three quarks for Muster Mark." It was weird. It was also right.
...
You can't put a quark under a [microscope](/biology). So how do physicists study particles that are mind-bogglingly small and often exist for mere fractions of a second?
...
You might be wondering why anyone should care about particles so tiny they make atoms look enormous. Fair question. Here's the thing — subatomic particle research has generated some of the most practical [technologies](/app-development) we use every day.

The World Wide Web was invented at CERN in 1989 by Tim Berners-Lee, who needed a way for physicists around the world to share data. MRI machines use the quantum properties of protons in your body to create detailed images. Radiation therapy for cancer uses accelerated particles to destroy tumors. Semiconductor [technology](/computer-hardware) — the foundation of every phone, computer, and modern device — depends on our understanding of how electrons behave in solid materials.
