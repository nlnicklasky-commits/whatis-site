...
description: "Superconductivity is a state where materials conduct electricity with zero resistance. Learn how it works, why it matters, and where it's used today."
...
wordCount: 804
tier: "3"
relatedArticles: ["electromagnetism", "quantum-mechanics", "materials-science", "electrical-engineering", "physics"]
externalSources:
  - title: "Superconductivity - DOE Office of Science"
    url: "https://www.energy.gov/science/doe-explainssuperconductivity"
  - title: "Superconductivity - CERN"
...
This is why magnets levitate above superconductors. The superconductor generates surface currents that create an opposing magnetic field, perfectly canceling the external field inside the material. The result is stable, frictionless levitation — one of the most visually striking demonstrations in all of [physics](/physics).
...
The frustrating part: nobody fully understands *why* these materials superconduct. BCS theory doesn't explain them. After nearly 40 years, the mechanism behind high-temperature superconductivity remains one of the biggest unsolved problems in [condensed matter physics](/solid-state-physics).
