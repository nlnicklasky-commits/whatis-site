...
heroAlt: "A construction worker wearing a hard hat and an orange safety vest, standing on a rocky hillside and using a surveying"
...
wordCount: 2227
tier: "2"
relatedArticles: ["cartography", "civil-engineering", "agriculture", "archaeology", "applied-mathematics"]
externalSources:
  - title: "NOAA — National Geodetic Survey"
    url: "https://geodesy.noaa.gov/"
  - title: "USGS — Geographic Information Systems"
    url: "https://www.usgs.gov/faqs/what-geographic-information-system-gis"
  - title: "Bureau of Labor Statistics — Surveyors"
    url: "https://www.bls.gov/ooh/architecture-and-engineering/surveyors.htm"
  - title: "Smithsonian — History of Surveying"
    url: "https://www.si.edu/spotlight/mapping"
faq:
  - q: "What does a surveyor actually do?"
    a: "A surveyor measures and maps land to determine property boundaries, elevations, and positions. They use instruments like GPS receivers, total stations, and drones to collect precise spatial data for construction, land sales, mapping, and legal disputes."
  - q: "How accurate is modern surveying?"
    a: "Modern GPS-based surveying can achieve accuracy of 1-2 centimeters horizontally and 2-3 centimeters vertically. High-precision techniques like Real-Time Kinematic (RTK) GPS can reach sub-centimeter accuracy."
  - q: "Do I need a survey to buy a house?"
    a: "It depends on your location and lender requirements. Many mortgage lenders require a survey to confirm property boundaries and identify encroachments, easements, or flood zone status. Even if not required, a survey can prevent costly boundary disputes later."
  - q: "What is the difference between a land survey and a topographic survey?"
...
[Cartography](/cartography) and surveying evolved together. In the Islamic Golden Age (8th-14th centuries), scholars like al-Biruni calculated the Earth's circumference with remarkable accuracy — his estimate of 6,339.9 km for the Earth's radius was within 16.8 km of the modern value. This was serious mathematical [surveying](/applied-mathematics) done with astrolabes and trigonometry.
...
Airborne LiDAR, mounted on aircraft or [drones](/aerospace-engineering), can map large areas quickly. Terrestrial laser scanners on tripods capture extraordinarily detailed 3D models of buildings, bridges, tunnels, and terrain. The resulting point clouds contain so much data that they essentially create digital twins of physical spaces.
