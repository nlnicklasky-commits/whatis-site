...
wordCount: 883
tier: "3"
relatedArticles: ["exercise-physiology", "sports-science", "fitness", "water-aerobics", "surfing"]
externalSources:
  - title: "USA Swimming"
    url: "https://www.usaswimming.org/"
  - title: "World Aquatics (FINA)"
    url: "https://www.worldaquatics.com/"
  - title: "CDC - Swimming and Water Safety"
    url: "https://www.cdc.gov/drowning/"
faq:
  - q: "What are the four competitive swimming strokes?"
    a: "The four official strokes are freestyle (front crawl), backstroke, breaststroke, and butterfly. Each has specific rules about body position, arm and leg movements, turns, and finishes. In the individual medley (IM) event, swimmers must perform all four strokes in order: butterfly, backstroke, breaststroke, freestyle."
  - q: "Is swimming good exercise?"
    a: "Extremely. Swimming works nearly every major muscle group, provides excellent cardiovascular conditioning, and burns 400-700 calories per hour depending on intensity and stroke. Because water supports your body weight, it's very low-impact — easy on joints, making it ideal for people with arthritis, injuries, or obesity. It's one of the few exercises recommended across all age groups."
  - q: "At what age should children learn to swim?"
    a: "The American Academy of Pediatrics says swim lessons can begin around age 1 and recommends that most children learn by age 4. However, swim lessons do not make children 'drown-proof' — adult supervision near water is always essential. Formal swim lessons starting at age 1-4 have been shown to reduce drowning risk by up to 88%."
---
...
The sport has been revolutionized repeatedly by technology and technique changes. The backstroke flip turn (1936), the underwater dolphin kick, high-tech [swimsuits](/sports-science) (now banned for being too effective), and advances in pool design and timing systems have all pushed records lower.
