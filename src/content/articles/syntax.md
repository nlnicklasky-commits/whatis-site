...
wordCount: 845
tier: "3"
relatedArticles: ["linguistics", "computational-linguistics", "communication-theory", "philosophy-of-education", "natural-language-processing"]
externalSources:
  - title: "Syntax - MIT OpenCourseWare"
  ...
  - title: "Syntax - Stanford Encyclopedia of Philosophy"
    url: "https://plato.stanford.edu/entries/linguistics/"
faq:
  - q: "What is the difference between syntax and grammar?"
    a: "Grammar is the broader term, covering all the rules of a language — syntax, morphology (word formation), phonology (sound patterns), and sometimes semantics (meaning). Syntax is specifically about sentence structure: how words are ordered and grouped to form phrases, clauses, and sentences. All syntax is grammar, but not all grammar is syntax."
  - q: "Do all languages have syntax?"
    a: "Yes. Every known human language has syntactic rules governing word order and sentence structure, though the specific rules vary enormously. English uses Subject-Verb-Object order ('The dog chased the cat'). Japanese uses Subject-Object-Verb. Some languages, like Latin, have very flexible word order because they use case endings instead to mark grammatical roles."
  - q: "What is Noam Chomsky's contribution to syntax?"
    a: "Chomsky proposed that all humans are born with an innate capacity for language — a 'universal grammar' that provides the basic framework for syntactic structure. His theories, starting with 'Syntactic Structures' (1957), revolutionized linguistics by treating syntax as a formal system that could be described with mathematical-style rules. While many of his specific proposals have been revised or challenged, his overall influence on the field is enormous."
---
...
Before Noam Chomsky published *Syntactic Structures* in 1957, [linguistics](/linguistics) was primarily descriptive — cataloging languages and their features. Chomsky proposed something radical: that syntax could be studied as a formal system, described with precise rules similar to mathematical formulas.
