...
heroAlt: "Technical writing is the practice of creating clear, precise documents that explain complex information to specific"
...
**Agile development** means features change rapidly. Documentation that was accurate last sprint might be wrong this sprint. Technical writers embedded in [agile software development](/agile-software-development) teams need to keep pace with developers — which requires attending standups, reading pull requests, and sometimes writing docs before features are fully finished.
