...
wordCount: 1884
tier: "3"
relatedArticles: ["amateur-radio", "cloud-computing", "digital-signal-processing", "communication-theory"]
externalSources:
  ...
  - title: "Submarine Cable Map — TeleGeography"
    url: "https://www.submarinecablemap.com/"
faq:
  - q: "What is the difference between telecommunications and networking?"
    a: "Telecommunications is the broader term covering all transmission of information over distances—phone calls, TV broadcasts, radio, internet. Networking specifically refers to connecting computers and devices to share data and resources. Networking is a subset of telecommunications focused on computer-to-computer communication."
  - q: "How does data travel across the ocean?"
    a: "Approximately 95-99% of intercontinental data travels through undersea fiber optic cables laid on the ocean floor. These cables, roughly the diameter of a garden hose, carry light pulses at nearly the speed of light. Satellites carry a small fraction of intercontinental traffic, mostly for remote areas."
  - q: "What does 5G actually do differently?"
    a: "5G offers three main improvements over 4G: faster peak speeds (up to 20 Gbps theoretical vs. 1 Gbps for 4G), lower latency (as low as 1 millisecond vs. 30-50ms for 4G), and support for many more simultaneous devices per cell tower. The real-world experience varies significantly by location and implementation."
  - q: "Will fiber optic internet become universal?"
    a: "Fiber deployment is expanding rapidly, but universal coverage faces economic challenges in rural and remote areas where the cost of installation per customer is high. Alternatives like fixed wireless (including 5G home internet) and satellite internet (Starlink) may serve these areas instead."
  - q: "Is landline phone service disappearing?"
