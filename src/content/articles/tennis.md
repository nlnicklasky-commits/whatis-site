---
title: "What Is Tennis?"
slug: tennis
description: "Tennis is a racket sport played by hitting a ball over a net on a court. Learn the rules, scoring system, major tournaments, and why millions play worldwide."
category: sports
...
wordCount: 850
tier: "3"
relatedArticles: ["table-tennis", "sports-science", "exercise-physiology", "sports-history", "sports-psychology"]
externalSources:
  - title: "International Tennis Federation"
    url: "https://www.itftennis.com/"
  - title: "Tennis - Olympic Games"
    url: "https://olympics.com/en/sports/tennis"
  - title: "ATP Tour"
    url: "https://www.atptour.com/"
faq:
  - q: "Why does tennis use such a weird scoring system?"
    a: "Tennis scoring (15, 30, 40, game) likely originated in medieval France, possibly based on the face of a clock (quarters: 15, 30, 45 — with 45 shortened to 40 for practical reasons). Nobody is completely sure. The system has survived because it creates natural drama — you must win by 2 points, and the 'deuce' system means games can extend indefinitely."
  - q: "What are the four Grand Slam tournaments?"
    a: "The Australian Open (January, hard court), the French Open/Roland-Garros (May-June, clay court), Wimbledon (June-July, grass court), and the US Open (August-September, hard court). Winning all four in a calendar year is called a Grand Slam — accomplished by only 5 players in singles history."
  - q: "Is tennis hard to learn?"
    a: "The basics — hitting the ball back and forth — can be picked up in a few lessons. But tennis has a steep learning curve for intermediate skills. Developing consistent groundstrokes, learning to serve, and building tactical awareness takes months to years. The good news: you don't need to be good to have fun. A rally between two beginners is still enjoyable exercise."
---

# What Is [Tennis](/table-tennis)?
...
It's one of the most popular individual [sports](/sports-science) in the world — played by an estimated 87 million people in over 200 countries. And unlike most sports, tennis produces genuinely gripping [drama](/drama) through a scoring system that means no lead is ever truly safe.
...
Tennis has been shaped by extraordinary rivalries. The "Big Three" — Roger Federer, Rafael Nadal, and Novak Djokovic — dominated men's tennis for nearly two decades, combining for 66 Grand Slam singles titles. Their contrasting styles (Federer's grace, Nadal's intensity, Djokovic's adaptability) produced some of the greatest matches in [sports](/sports-history) history.
