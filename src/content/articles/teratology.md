...
heroAlt: "Teratology is the study of birth defects and congenital malformations, including their causes, mechanisms, and prevention"
...
Understanding teratology requires understanding [embryonic development](/developmental-biology), because the timing of an exposure determines what structures are affected. Development follows a strict schedule, and different organ systems have different windows of vulnerability.
...
1. **Susceptibility depends on genotype.** The same exposure can cause defects in one genetic background and not another. This explains why some medications are teratogenic in rabbits but not rats, or why some human fetuses are affected while others aren't.

2. **Susceptibility varies with developmental stage.** Timing matters more than almost anything else.

3. **Teratogens act through specific mechanisms.** They might inhibit cell division, block cell migration, disrupt cell signaling, restrict blood supply, or trigger cell death at the wrong time and place.

4. **The outcome depends on the nature of the agent.** Different teratogens produce different patterns of defects.

5. **Access to the embryo matters.** The placenta blocks some substances but not others. Molecular size, lipid solubility, and protein binding all affect whether a compound reaches the embryo.

6. **Dose determines the response.** There's typically a threshold below which no effect occurs, and the severity increases with dose. This is the dose-response relationship, and establishing it is central to risk assessment.
...
- **T**oxoplasmosis — a parasitic infection from undercooked meat or cat feces
- **O**ther (syphilis, varicella, parvovirus B19)
- **R**ubella — caused devastating epidemics of birth defects before vaccination
- **C**ytomegalovirus (CMV) — the most common congenital infection worldwide
...
Beyond individual chemical exposures, teratology increasingly addresses broader environmental concerns. Wildlife teratologists study birth defects in wild populations as sentinel indicators of [environmental contamination](/climatology). Frogs with extra limbs, fish with spinal deformities, birds with crossed bills — these aren't just curiosities. They're signals.
