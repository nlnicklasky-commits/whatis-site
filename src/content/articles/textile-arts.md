...
heroAlt: "A woman working on a loom in a room with various plants and books visible in the background"
...
wordCount: 802
tier: "3"
relatedArticles: ["textile-design", "tapestry", "fashion-history", "tailoring", "aesthetics"]
externalSources:
  - title: "Textile Museum - George Washington University"
    url: "https://museum.gwu.edu/"
  - title: "Textile Arts - Victoria and Albert Museum"
    url: "https://www.vam.ac.uk/"
  - title: "Surface Design Association"
    url: "https://www.surfacedesign.org/"
faq:
  - q: "What is the difference between textile arts and fiber arts?"
    a: "The terms are often used interchangeably. 'Textile arts' traditionally refers to techniques that produce fabric (weaving, knitting, crocheting). 'Fiber arts' is a broader term that includes textile arts plus non-fabric fiber work like basketry, cordage, papermaking, and sculptural fiber installations. In contemporary practice, the distinction has blurred — most artists and institutions use the terms as near-synonyms."
  - q: "Are textile arts considered fine art?"
...
**Sustainability** — Growing awareness of fast [fashion's](/fashion-history) environmental impact has renewed interest in handmade, repaired, and naturally dyed textiles. Slow fashion and the "make do and mend" ethos align naturally with textile arts.
