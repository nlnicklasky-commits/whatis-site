...
The boundary between medicine and poison is just dosage. [Pharmacology](/pharmacology) and toxicology are really two sides of the same coin, separated only by how much of a substance enters the body and what it does once it gets there.
...
**Inhalation** — substances enter through the lungs and pass directly into the bloodstream. There's no first-pass liver metabolism, so the dose that reaches target organs can be much higher. This is why inhaling chemical vapors is often far more dangerous than skin contact with the same [chemical](/chemistry).
...
Regulatory toxicologists work for agencies like the [EPA](https://www.epa.gov/chemical-research/toxicology-testing-21st-century-tox21), FDA, and their international equivalents, setting safety standards for chemicals in food, water, air, consumer products, and workplaces. They determine "safe" exposure levels — though "safe" always involves judgment calls about acceptable risk.
