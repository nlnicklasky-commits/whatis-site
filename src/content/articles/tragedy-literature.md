---
title: "What Is Tragedy (Literature)?"
slug: tragedy-literature
...
wordCount: 849
tier: "3"
relatedArticles: ["theatrical-history", "theater-arts", "ancient-greek-history", "storytelling", "ethics"]
externalSources:
  - title: "Tragedy - Britannica"
    url: "https://www.britannica.com/art/tragedy-literature"
  - title: "Greek Tragedy - MIT"
    url: "https://classics.mit.edu/"
  - title: "Aristotle's Poetics - Stanford Encyclopedia"
    url: "https://plato.stanford.edu/entries/aristotle-poetics/"
faq:
  - q: "What makes a story a tragedy?"
    a: "A tragedy features a protagonist of significant stature who falls from prosperity to misery through some combination of personal flaws, fate, or circumstances beyond their control. The fall is irreversible and usually ends in death or ruin. The audience experiences emotions of pity and fear — what Aristotle called catharsis — through witnessing the protagonist's suffering."
  - q: "What is a 'tragic flaw'?"
    a: "The tragic flaw (hamartia in Greek) is a quality in the protagonist that contributes to their downfall. Hamlet's indecision, Macbeth's ambition, Othello's jealousy, and Oedipus's pride are classic examples. However, Aristotle's original concept was broader — hamartia means 'error' or 'missing the mark,' not necessarily a character deficiency. Some tragedies feature protagonists who make reasonable decisions that lead to disastrous outcomes."
  - q: "Is tragedy still written today?"
    a: "Yes, though the form has evolved. Arthur Miller's 'Death of a Salesman' (1949) reimagined tragedy with an ordinary working man as the hero. Modern tragedies appear in film (Schindler's List, Requiem for a Dream), television (Breaking Bad), and literature (Beloved by Toni Morrison). The themes of inevitable suffering, moral complexity, and human limitation remain as relevant as ever."
---
...
Other modern [tragedies](/storytelling) include Tennessee Williams's *A Streetcar Named Desire*, Eugene O'Neill's *Long Day's Journey into Night*, and August Wilson's *Fences*. Film has produced powerful tragic narratives: *Schindler's List*, *There Will Be Blood*, and *Moonlight* all follow tragic structures.
