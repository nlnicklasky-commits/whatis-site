---
title: "What Is Tropical Ecology?"
slug: tropical-ecology
...
This staggering difference has puzzled ecologists since Alexander von Humboldt first noticed the pattern in the early 1800s. The question — why are the tropics so absurdly rich in species? — remains one of the biggest open problems in [biology](/biology).
...
While temperate ecosystems are usually limited by nitrogen availability, many tropical forests are limited by [phosphorus](/chemistry). Unlike nitrogen, which can be fixed from the atmosphere by bacteria, phosphorus comes almost entirely from rock weathering. In ancient tropical soils that have been weathered for millions of years, most of the available phosphorus has already been leached away or locked into insoluble compounds.
...
Tropical ecology isn't just about forests. The warm, sunlit waters between the tropics support [coral reefs](/coral-reef-ecology), mangrove forests, and seagrass beds — ecosystems with biodiversity levels that rival or exceed anything on land.
...
Tropical forests regulate global [climate](/climatology) in ways that affect everyone. They store roughly 250 billion metric tons of carbon. When burned or cleared, that carbon enters the atmosphere as CO2. Tropical deforestation accounts for approximately 8-10% of global greenhouse gas emissions — more than the entire transportation sector of the European Union.
...
Even if you've never set foot in a tropical forest, your life is connected to tropical ecology in ways you probably don't realize. Your morning coffee, the chocolate in your pantry, the rubber in your car's tires, the tropical hardwood in your furniture — all of these come from tropical ecosystems. The [medicine](/anatomy) in your cabinet may contain compounds first discovered in tropical plants. About 25% of modern pharmaceuticals are derived from tropical forest organisms.
