...
wordCount: 1044
tier: "3"
relatedArticles: ["type-design", "typesetting", "visual-arts", "printmaking"]
externalSources:
  - title: "Google Fonts — Free Typography Resources"
    url: "https://fonts.google.com/"
  - title: "Type Directors Club"
    url: "https://tdc.org/"
  - title: "Encyclopaedia Britannica — Typography"
    url: "https://www.britannica.com/technology/typography"
faq:
  - q: "What are the main categories of typefaces?"
    a: "The four main categories are serif (with small finishing strokes, like Times New Roman), sans-serif (without serifs, like Helvetica), script (mimicking handwriting, like Brush Script), and display/decorative (designed for headlines and large sizes, like Impact). Within these categories, there are many subcategories — old-style serifs, geometric sans-serifs, slab serifs, and more."
  - q: "Why does typography matter?"
    a: "Typography directly affects readability, comprehension speed, and emotional response. Research shows that people form opinions about content credibility partly based on the typeface used. Poor typography increases reading effort and reduces engagement, while good typography makes content accessible and professional. In branding, typography is often the single most recognizable design element."
  - q: "How many fonts should you use in a design?"
    a: "The standard guideline is two to three — one for headings and one for body text, with an optional third for accents or captions. Using too many fonts creates visual chaos and looks unprofessional. The key is choosing fonts that contrast enough to create hierarchy but share enough visual characteristics to feel cohesive."
---
