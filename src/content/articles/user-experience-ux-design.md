...
slug: user-experience-ux-design
...
heroAlt: "A woman working on a laptop in an office setting, surrounded by other people and office equipment"
...
wordCount: 2270
tier: "2"
relatedArticles: ["app-development", "agile-software-development", "design-patterns", "algorithms"]
externalSources:
  - title: "Nielsen Norman Group"
    url: "https://www.nngroup.com/"
  - title: "Interaction Design Foundation"
    url: "https://www.interaction-design.org/"
  - title: "UXPA - User Experience Professionals Association"
    url: "https://uxpa.org/"
...
The best product teams integrate these roles throughout the process rather than passing work sequentially (design it, then build it, then analyze it). [Agile methodologies](/agile-software-development) — working in short iterative cycles — have largely replaced waterfall approaches where design was completed entirely before development began.
...
The Web Content Accessibility Guidelines (WCAG) provide specific, testable criteria. Level AA compliance is the standard most organizations aim for and is legally required in many contexts (the ADA has been interpreted to apply to websites and [apps](/app-development)).
