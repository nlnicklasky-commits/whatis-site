...
description: "Workplace safety is the set of policies, procedures, and practices designed to protect employees from physical injury, illness."
category: business
tags: ["workplace safety", "business"]
heroImage: "/images/articles/workplace-safety-hero.webp"
heroAlt: "A man wearing a yellow hard hat and a yellow safety vest, holding a tablet device"
...
wordCount: 1662
tier: "3"
relatedArticles: ["ergonomics", "occupational-health", "business-ethics", "human-factors", "insurance"]
externalSources:
  - title: "OSHA - Occupational Safety and Health Administration"
    url: "https://www.osha.gov/"
  - title: "NIOSH - National Institute for Occupational Safety and Health"
    url: "https://www.cdc.gov/niosh/"
  - title: "Bureau of Labor Statistics - Injuries, Illnesses, and Fatalities"
    url: "https://www.bls.gov/iif/"
  - title: "WHO - Occupational Health"
    url: "https://www.who.int/health-topics/occupational-health"
faq:
  - q: "What is OSHA and what does it do?"
...
The turning point was 1970, when Congress passed the Occupational Safety and Health Act, creating [OSHA](https://www.osha.gov/). Since then, workplace fatality rates have dropped by more than 60%. That's extraordinary progress. But thousands of people still die on the job every year, which means there's still a lot of work to do.
...
These are the ones people picture first: falling from heights, getting hit by moving machinery, electrocution, extreme temperatures. Construction, manufacturing, and [agriculture](/agriculture) have the highest rates of physical hazard exposure. Falls alone account for roughly 700 workplace deaths per year in the U.S., making them the leading cause of death in construction.

### Chemical Hazards

Workers in manufacturing, healthcare, cleaning, and [agriculture](/agriculture) routinely handle substances that can cause burns, respiratory damage, or long-term illness. Think solvents, pesticides, cleaning agents, and heavy metals. The tricky part about chemical hazards is that many effects aren't immediate — a worker might be exposed to a carcinogen for years before symptoms appear.
...
Don't laugh. Office workers deal with [ergonomic](/ergonomics) issues (carpal tunnel syndrome, back pain from poor seating), indoor air quality problems, slip-and-fall hazards, and increasingly, psychosocial stressors. Just because nobody's swinging a crane doesn't mean the workplace is hazard-free.
...
**Remote work** created new safety considerations — home office ergonomics, isolation-related mental health effects, and blurred boundaries between work and personal life. Most [occupational health](/occupational-health) frameworks weren't designed for a workforce that operates from kitchen tables.
