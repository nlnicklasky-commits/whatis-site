---
title: "What Is Zincography?"
slug: zincography
description: "Zincography is a printmaking technique using zinc plates instead of limestone for lithographic printing. Learn its history, process, and lasting influence."
...
heroAlt: "A close-up view of a person's hand holding a magnifying glass over a detailed, intricate pattern on a piece of paper or"
...
wordCount: 1123
tier: "3"
relatedArticles: ["textile-history", "technical-drawing", "aesthetics"]
externalSources:
  - title: "Encyclopedia Britannica - Lithography"
    url: "https://www.britannica.com/technology/lithography"
  - title: "Smithsonian Libraries - History of Printing"
    url: "https://library.si.edu/exhibition/color-in-a-new-light/lithography"
  - title: "Library of Congress - Prints and Photographs"
    url: "https://www.loc.gov/pictures/"
  - title: "Victoria and Albert Museum - Printmaking Techniques"
    url: "https://www.vam.ac.uk/articles/printmaking-techniques-explained"
faq:
  - q: "What is the difference between zincography and lithography?"
    a: "Lithography uses a flat limestone slab as the printing surface, while zincography uses a thin zinc plate. The underlying chemistry is the same — both rely on the mutual repulsion of oil and water. Zinc plates replaced limestone because they're lighter, cheaper, easier to store, and can be bent around rotary press cylinders for high-speed printing. Zincography is essentially lithography adapted for industrial use."
  - q: "Is zincography still used today?"
    a: "The term 'zincography' has fallen out of common use, but the technique it pioneered — offset lithography using metal plates — dominates commercial printing to this day. Modern offset presses use aluminum plates rather than zinc, but the basic principle is unchanged. So while the name is historical, the method's descendants are everywhere."
  - q: "Can you do zincography at home?"
