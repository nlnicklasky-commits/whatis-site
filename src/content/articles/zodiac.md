...
heroAlt: "Circular zodiac chart showing the twelve astrological signs against a starry night sky"
...
externalSources:
  - title: "NASA — Constellations and the Calendar"
    url: "https://spaceplace.nasa.gov/starfinder2/en/"
  - title: "Britannica — Zodiac"
    url: "https://www.britannica.com/topic/zodiac"
  - title: "International Astronomical Union — Constellation Boundaries"
    url: "https://www.iau.org/public/themes/constellations/"
  - title: "Stanford Encyclopedia of Philosophy — Astrology"
    url: "https://plato.stanford.edu/entries/astrology/"
faq:
  - q: "What are the 12 zodiac signs?"
    a: "The 12 zodiac signs are Aries, Taurus, Gemini, Cancer, Leo, Virgo, Libra, Scorpio, Sagittarius, Capricorn, Aquarius, and Pisces. Each corresponds to roughly one month of the year based on the sun's apparent position."
  - q: "Is the zodiac the same in astronomy and astrology?"
    a: "No. Astronomy uses 88 constellations with precise boundaries set by the International Astronomical Union, while astrology divides the ecliptic into 12 equal 30-degree segments that no longer align with the actual constellations due to precession."
  - q: "What is the difference between your sun sign and your moon sign?"
    a: "Your sun sign is based on the sun's position at your birth and represents your core identity. Your moon sign is based on the moon's position and is said to reflect your emotional inner world and instincts."
  - q: "Do scientists consider zodiac-based astrology valid?"
    a: "No. Multiple large-scale studies have found no statistical evidence that zodiac signs predict personality traits, life events, or compatibility. Astrology is classified as a pseudoscience by the scientific community."
  - q: "Why do some people say there are 13 zodiac signs?"
...
This means if you were born on April 5 and identify as an Aries, the sun was astronomically in Pisces at your birth. Astrologers have a response to this — they distinguish between the "tropical zodiac" (based on seasons and equinoxes) and the "sidereal zodiac" (based on actual constellation positions). Western astrology uses the tropical system, so astrologers argue the shift doesn't matter because they're tracking seasons, not stars. Vedic [astrology](/astrology) from India uses the sidereal system, which accounts for precession.
...
This is the elephant in the room. Does zodiac-based [astrology](/astrology) actually predict anything?
...
The zodiac sits at a fascinating intersection between [science](/scientific-method), [philosophy](/philosophy), and [spirituality](/religion). It raises questions worth thinking about even if you reject astrology entirely.
