...
externalSources:
  - title: "Britannica — Zoology"
    url: "https://www.britannica.com/science/zoology"
  - title: "University of Michigan — Museum of Zoology"
    url: "https://lsa.umich.edu/ummz"
  - title: "Smithsonian National Zoo — Conservation Biology"
    url: "https://nationalzoo.si.edu/conservation"
  - title: "Nature — Animal Behaviour Collection"
    url: "https://www.nature.com/subjects/animal-behaviour"
faq:
  - q: "What do zoologists actually do?"
    a: "Zoologists study animals through fieldwork, lab research, and data analysis. They observe behavior in the wild, study anatomy and genetics, track populations, research diseases, and develop conservation strategies. Some work in zoos, universities, government agencies, or wildlife organizations."
  - q: "What is the difference between zoology and biology?"
    a: "Biology is the broad study of all living organisms, including plants, fungi, bacteria, and animals. Zoology is a specialized branch of biology focused exclusively on animals — their structure, behavior, evolution, and ecology."
  - q: "How many animal species have been identified?"
    a: "Scientists have identified and described approximately 1.5 million animal species, but estimates suggest the total number could be between 8 and 10 million. Most undiscovered species are invertebrates, particularly insects and deep-sea organisms."
  - q: "Do you need a PhD to be a zoologist?"
    a: "Not always. Entry-level wildlife technician or zoo positions may require only a bachelor's degree. However, research positions, university teaching, and senior roles in conservation typically require a master's or PhD in zoology or a related field."
  - q: "What is the difference between zoology and veterinary science?"
...
Then came Charles Darwin. His *On the Origin of Species* (1859) didn't just change zoology — it rewired our entire understanding of life. The theory of [evolution](/evolutionary-biology) by natural selection provided the mechanism that explained why animals are the way they are. Before Darwin, zoologists described. After Darwin, they could explain.
...
- **[Entomology](/entomology):** Insects. The largest branch by sheer number of species — there are over 1 million described insect species, and possibly 5-10 million total.
- **[Ornithology](/ornithology):** Birds. About 10,800 known species.
- **[Mammalogy](/mammalogy):** Mammals. Roughly 6,500 species.
- **[Herpetology](/herpetology):** Reptiles and amphibians. Around 18,000 combined.
- **[Ichthyology](/ichthyology):** Fish. Over 35,000 species — more than all other vertebrates combined.
- **[Malacology](/malacology):** Mollusks. Snails, clams, octopuses, and about 85,000 species.
- **[Parasitology](/parasitology):** Parasites across all animal groups.
...
- **[Anatomy](/anatomy):** The physical structure of animal bodies.
- **[Physiology](/human-physiology):** How animal bodies function — circulation, respiration, digestion, nervous systems.
- **[Ethology](/ethology):** [Animal behavior](/animal-behavior) — how and why animals act the way they do.
- **[Ecology](/ecology):** How animals interact with each other and their environments.
- **[Genetics](/genetics):** Heredity, DNA, and how traits are passed between generations.
- **[Evolutionary biology](/evolutionary-biology):** How species change over time through natural selection and other mechanisms.
- **[Conservation biology](/conservation-biology):** Protecting threatened species and ecosystems.

### The Molecular Revolution

Since the 1990s, [molecular biology](/molecular-biology) has radically reshaped zoology. DNA sequencing lets scientists determine evolutionary relationships between species with far greater precision than physical appearance ever could. Some long-accepted classifications have been overturned entirely.
...
[Taxonomy](/taxonomy) — the science of naming and classifying organisms — is the organizational backbone of zoology. The modern classification system arranges life into a hierarchy:
...
Every zoologist operates within the framework of [evolutionary biology](/evolutionary-biology). Nothing about animals makes sense unless you understand that every feature — every wing, claw, color pattern, behavior, and enzyme — was shaped by millions of years of natural selection.
...
[Animal behavior](/animal-behavior) is one of zoology's most accessible and fascinating branches. Why do birds sing? How do bees communicate the location of flowers? Why do some species cooperate while others compete?
...
No animal exists in isolation. Every species is embedded in an [ecosystem](/ecology) — a web of relationships with other organisms and the physical environment.
